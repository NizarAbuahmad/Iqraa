# CQV Report — مساحة المثلث باستعمال جيب الزاوية
...
- **Semester:** 2
- **Unit:** تطبيقات المثلثات (Applications of Trigonometry)
- **Lesson:** مساحة المثلث باستعمال جيب الزاوية
- **Lesson ID:** `lesson-math-s2-4-4`
- **Artifact:** درس تفاعلي / Interactive Lesson (`interactive-lesson`)
