# CQV Report — حل نظام مكون من معادلة خطية ومعادلة تربيعية
...
- **Semester:** 2
- **Unit:** المعادلات (Equations)
- **Lesson:** حل نظام مكون من معادلة خطية ومعادلة تربيعية
- **Lesson ID:** `lesson-math-s2-1-2`
