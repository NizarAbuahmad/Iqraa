...
const TERMS_AR: LegalDoc = {
  ...
  sections: [
    {
      heading: '1) من يستطيع استخدام التطبيق',
      body: [
    ...
    {
      heading: '2) مسؤولية المعلّم عن بيانات طلبته',
      body: [
    ...
    {
      heading: '4) المحتوى المولَّد بالذكاء الاصطناعي',
      body: [
    ...
    {
      heading: '5) المناهج وحقوق المؤلّف',
      body: [
