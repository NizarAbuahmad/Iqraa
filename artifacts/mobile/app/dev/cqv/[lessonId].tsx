...
const styles = StyleSheet.create({
  ...
  headerChipText: { color: '#fff', fontFamily: 'Cairo_600SemiBold', fontSize: 12 },
  ...
  batchBtnText: { color: '#fff', fontFamily: 'Cairo_700Bold', fontSize: 15 },
  batchHint: {
    color: '#64748B',
    fontFamily: 'Almarai_400Regular',
    fontSize: 12,
  ...
  checkLabel: { color: NAVY, fontFamily: 'Cairo_600SemiBold', fontSize: 13 },
  checkLabelAr: { color: '#94A3B8', fontFamily: 'Almarai_400Regular', fontSize: 11, textAlign: 'right' },
  checkScore: { color: NAVY, fontFamily: 'Cairo_700Bold', fontSize: 13 },
  checkOverall: {
    marginTop: 10,
    paddingTop: 10,
    borderTopWidth: 1,
  ...
  linkBtnText: { color: TEAL, fontFamily: 'Cairo_600SemiBold', fontSize: 12 },
  artifactGrid: {
    flexDirection: 'row',
    flexWrap: 'wrap',
    gap: 8,
  ...
  artifactChipEn: { color: '#94A3B8', fontFamily: 'Almarai_400Regular', fontSize: 11 },
  ...
  primaryBtnText: { color: '#fff', fontFamily: 'Cairo_600SemiBold', fontSize: 14 },
  note: {
    color: '#64748B',
    fontFamily: 'Almarai_400Regular',
    fontSize: 12,
  ...
  errorNote: { color: DANGER, fontFamily: 'Almarai_400Regular', fontSize: 12 },
  previewBox: {
  ...
  cardMeta: { color: '#64748B', fontFamily: 'Almarai_400Regular', fontSize: 12 },
  fieldLabel: {
    color: NAVY,
    fontFamily: 'Cairo_600SemiBold',
    fontSize: 12,
  ...
  scoreLabel: { flex: 1, color: '#334155', fontFamily: 'Almarai_400Regular', fontSize: 13 },
  scoreInput: {
    width: 64,
    borderWidth: 1,
    borderColor: '#E2E8F0',
  ...
  secondaryBtnText: { color: NAVY, fontFamily: 'Cairo_600SemiBold', fontSize: 13 },
