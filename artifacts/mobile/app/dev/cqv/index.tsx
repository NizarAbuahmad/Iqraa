...
const styles = StyleSheet.create({
  ...
  exportChipText: { color: '#fff', fontFamily: 'Cairo_600SemiBold', fontSize: 11 },
  semCard: {
    backgroundColor: '#fff',
    borderRadius: 12,
    borderWidth: 1,
  ...
  semTitle: { color: NAVY, fontFamily: 'Cairo_700Bold', fontSize: 15, marginBottom: 4 },
  semLine: { color: '#475569', fontFamily: 'Almarai_400Regular', fontSize: 13 },
  semStrong: { fontFamily: 'Cairo_700Bold', color: NAVY },
  barTrack: {
    marginTop: 8,
    height: 8,
    borderRadius: 4,
  ...
  cardTitle: { color: NAVY, fontFamily: 'Cairo_700Bold', fontSize: 15 },
  cardHint: { color: '#64748B', fontFamily: 'Almarai_400Regular', fontSize: 12, marginBottom: 4 },
  metricBlock: {
    paddingVertical: 6,
  ...
  metricLabel: { color: '#334155', fontFamily: 'Almarai_400Regular', fontSize: 13 },
  metricLabelBold: { color: NAVY, fontFamily: 'Cairo_700Bold', fontSize: 13 },
  metricValue: { color: NAVY, fontFamily: 'Cairo_600SemiBold', fontSize: 14 },
  metricValueBold: { color: TEAL, fontFamily: 'Cairo_700Bold', fontSize: 16 },
  metricMeta: { color: '#94A3B8', fontFamily: 'Almarai_400Regular', fontSize: 11 },
  ...
  queueCat: { color: TEAL, fontFamily: 'Cairo_600SemiBold', fontSize: 10, textTransform: 'uppercase' },
  queueTitle: { color: NAVY, fontFamily: 'Cairo_700Bold', fontSize: 14, textAlign: 'right' },
  queueReason: { color: '#64748B', fontFamily: 'Almarai_400Regular', fontSize: 12 },
  queueRight: { alignItems: 'flex-end', gap: 2, minWidth: 48 },
  queueSem: { color: '#94A3B8', fontFamily: 'Cairo_600SemiBold', fontSize: 11 },
  queueScore: { color: NAVY, fontFamily: 'Cairo_700Bold', fontSize: 14 },
  queueScoreMuted: { color: '#CBD5E1', fontFamily: 'Cairo_700Bold', fontSize: 14 },
  lessonRow: {
    backgroundColor: '#fff',
    borderRadius: 12,
    borderWidth: 1,
  ...
  badgeText: { color: TEAL, fontFamily: 'Cairo_700Bold', fontSize: 14 },
  badgeSub: { color: '#94A3B8', fontFamily: 'Almarai_400Regular', fontSize: 10 },
  blocked: {
    flex: 1,
  ...
  blockedTitle: { fontFamily: 'Cairo_700Bold', fontSize: 20, color: NAVY },
  blockedBody: { fontFamily: 'Almarai_400Regular', fontSize: 14, color: '#64748B', lineHeight: 22 },
  backBtn: {
    marginTop: 12,
  ...
  backBtnText: { color: '#fff', fontFamily: 'Cairo_600SemiBold' },
});
