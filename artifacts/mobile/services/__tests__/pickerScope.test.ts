 ...
 * list (see `scopePickerParams`). So entries stay and get greyed instead, and
 * generation re-checks for URLs saved before they did.
 */
...
describe('picker scope — grade/subject pairs with no book', () => {
  // A short array would silently grey the wrong rows: `disabled[i]` is read
  ...
  it('greys english for grade-9 but not for grade-10', () => {
