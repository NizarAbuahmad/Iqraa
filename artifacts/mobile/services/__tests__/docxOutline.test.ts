...
const planLines = [
  ...
  'التمهيد',
  '───────',
  'اعرض موقفًا حياتيًا مرتبطًا بالاشتقاق واطلب من الطلبة التنبؤ بالنتيجة قبل الحساب.',
  '',
  'التقييم',
  '───────',
  ...
  '',
  '═══════════════════════════════',
  'أُنشئ بواسطة اقرأ — مساعد التدريس الذكي',
];
...
describe('classifyDocLines', () => {
  ...
  it('leaves Arabic prose as body text', () => {
    ...
    assert.equal(
      at('اعرض موقفًا حياتيًا مرتبطًا بالاشتقاق واطلب من الطلبة التنبؤ بالنتيجة قبل الحساب.'),
      'body',
    );
    ...
    assert.equal(at('أُنشئ بواسطة اقرأ — مساعد التدريس الذكي'), 'body');
  });
