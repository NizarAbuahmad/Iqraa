...
export const MOCK_NOTIFICATIONS = [
  { id: 'n1', title: 'تحديث المنهاج', titleEn: 'Curriculum Update', body: 'تم تحديث منهج الكيمياء للصف العاشر للعام 2024-2025.', bodyEn: 'Grade 10 Chemistry curriculum updated for 2024-2025.', time: 'منذ ساعتين', timeEn: '2h ago', read: false, type: 'info' },
