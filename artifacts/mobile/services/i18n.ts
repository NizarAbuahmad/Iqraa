...
const translations = {
  ar: {
    ...
    removePhotoConfirm: 'هل تريد إزالة صورتك الشخصية؟',
    photoUploading: 'جارٍ رفع الصورة…',
    photoPermissionNeeded: 'يحتاج «اقرأ» إلى إذن الوصول إلى صورك لاختيار صورة.',
    photoUnsupported: 'صيغة هذه الصورة غير مدعومة. اختر صورة بصيغة JPEG أو PNG أو WebP.',
    photoTooLarge: 'هذه الصورة كبيرة جدًا. اختر صورة أصغر.',
    photoUnavailable: 'رفع الصور الشخصية غير مُفعّل على هذا الخادم بعد.',
    photoFailed: 'تعذّر تحديث صورتك الشخصية. حاول مرة أخرى.',
  ...
  en: {
    ...
    photoUploading: 'Uploading your picture…',
    photoPermissionNeeded: 'Iqraa needs permission to open your photos to choose a picture.',
    photoUnsupported: "That image format isn't supported. Choose a JPEG, PNG or WebP photo.",
    photoTooLarge: 'That picture is too large. Choose a smaller one.',
    photoUnavailable: 'Profile pictures are not set up on this server yet.',
    photoFailed: 'Could not update your profile picture. Try again.',
