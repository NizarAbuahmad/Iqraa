...
const translations = {
  ar: {
    ...
    emailNotVerifiedError: 'يرجى تأكيد بريدك الإلكتروني قبل تسجيل الدخول',
    ...
    curriculumShortcutSub: 'الصف العاشر · الرياضيات · الفصلان الأول والثاني',
    ...
    libraryAdminFileHint: 'صور، PDF، Word، PowerPoint، صوت، فيديو قصير — حتى ٢٥ ميغابايت. للفيديو الطويل أو الألعاب الإلكترونية استخدم رابطًا.',
    ...
    libraryAdminTooBig: 'الملف أكبر من ٢٥ ميغابايت — ارفعه على يوتيوب أو Drive وأضفه كرابط.',
    ...
    resourceActionAddToClass: 'أضف إلى الصف',
    resourceActionRun: 'ابدأ النشاط',
    resourceActionOpen: 'فتح',
    ...
    photoRemoveFailed: 'فشل إزالة الصورة',
    ...
    faqA8: 'الشُّعَب تربط التقويم بأسماء طلبتك، فيصبح لكل طالب مستوى ونقاط قوة وفجوات. أضف شعبةً من «حسابي ← شُعَبي»، والصق أسماء الطلبة دفعة واحدة.',
    ...
    rosterNeedsConnection: 'قائمة الطلبة تحتاج اتصالاً بالخادم',
    ...
    teachingPlansNeedsConnection: 'خطط التدريس تحتاج اتصالاً بالخادم',
    ...
    miniEvalNeedsLiveAi:
      'التقييم السريع يحتاج توليدًا بالذكاء الاصطناعي، وهو غير مُفعَّل الآن. أنشئ امتحانًا كاملًا بأسئلة مقالية، أو فعِّل التوليد الحيّ.',
    ...
    joinAnotherClassDesc: 'أدخل رمز ربط آخر لإضافة ارتباط جديد — لطفل آخر، أو ولي أمر آخر لنفس الطفل، أو معلم آخر.',
  ...
  en: {
    ...
    forgotPasswordSubtitle: 'Enter your email and we will send it a 6-digit code.',
    ...
    libraryAdminItemTitle: 'Title (Arabic)',
    ...
    premadeSheetsPending: 'The ready-made worksheets have not been built yet.',
    resourceKindWorksheet: 'Worksheet',
    resourceKindGame: 'Activity',
    ...
    slidesFromPromptLink: 'Or describe the deck in your own words →',
    ...
    promptSlidesSourcePlaceholder: 'Paste the lesson text, an article, or your own notes — the slides will be built from it instead of from what the model recalls.',
    ...
    promptSlidesEmptyHint: 'Describe your deck above, then tap "Build slides".',
    // Class Challenge (phone-free team game)
    ...
    planTime: 'Time',
    planTimePlaceholder: 'e.g. Sun & Tue 8-9am',
    ...
    teachingPlansStorageUnavailable: 'Teaching plan storage is not set up on the server yet. Ask your administrator to enable it.',
    ...
    miniEvalNeedsLiveAi:
      'A quick evaluation needs AI generation, which is off right now. Create a full exam with written questions instead, or turn live generation on.',
    miniEvalNoObjectives: 'No objectives for this class — choose a curriculum on the full exam screen',
    miniEvalGenerate: 'Generate the questions',
    ...
    miniEvalRegenerate: 'Generate different ones',
    ...
    evalRowQuestions: (n: number) => `${n} questions`,
    ...
    readAloudFailed: 'Could not save that recording. Please try again.',
    ...
    dictationAddBtn: (n: string) => `Add ${n} questions`,
    ...
    shelfEmbedOnly: 'Show only — may not be copied.',
    ...
    onboardingSlide6Title: 'Ask IQRA about any lesson',
    ...
    onboardingSlide2Desc: 'Objectives, warmup, activity, practice, worksheet and exit ticket — built in sequence, not as scattered pieces.',
    onboardingSlide2Points: 'Objectives and warmup\nActivity and practice\nWorksheet and exit ticket',
    ...
    onboardingSlide8Title: 'Tests students answer on their phones',
    ...
    onboardingSlide5Desc: "Enter the link code from the teacher to link your account to the class, get their messages and notifications, and browse the curriculum any time.",
    ...
    messagingCreateGroupError: 'Could not create the group. Please try again.',
    ...
    messagingRegenerateCode: 'Replace with a new code',
    ...
    messagingStudentAccountsOffBody:
      'No one can create a student or parent account in this version, so a link code has nothing to redeem yet. Your roster and your notes are unaffected.',
    ...
    messagingNoContactsDesc:
      'The students on your roster do not have accounts yet. Open your class, tap "Link code", and share the code with parents and students so they can sign up.',
    ...
    teacherSetupContinue: 'Continue',
    teacherSetupSave: 'Save',
    teacherSetupPickAtLeastOne: 'Pick at least one subject for each grade you added',
    teacherSetupFailed: 'Could not save your grades and subjects. Please try again.',
    ...
    editTeachingTitle: 'Grades & Subjects',
    rosterLinked: 'Joined',
    ...
    hubWrong: (w: string) => `The answer is: ${w}`,
