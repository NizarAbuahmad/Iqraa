...
const translations = {
  ar: {
    ...
    faqA3: 'خطة درس، ورقة عمل، واجب منزلي، أداة تقييم، نشاط صفي، وتبسيط الشرح — كلها من زر ➕. ما يمكن للمحادثة إنتاجه يظهر مباشرة في المحادثة، وما يحتاج شاشة خاصة (وضع الحصة، مسار الدرس، جيوجبرا) ينتقل إليها ومعه الدرس الحالي.',
