...
/** Same four-case rule as arCountStudents, for a count of sections. */
export function arCountClasses(n: number): string {
  if (n === 0) return 'لا شُعَب';
  if (n === 1) return 'شعبة واحدة';
  if (n === 2) return 'شعبتان';
  if (n >= 3 && n <= 10) return `${n} شُعَب`;
  return `${n} شعبةً`;
}
...
const translations = {
  ar: {
    ...
    loginValueProp: 'منصة عربية لتحضير الدروس ومتابعة الطلبة وفق المنهاج الأردني',
    ...
    passwordMinHint: '8 أحرف على الأقل',
    passwordsDoNotMatch: 'كلمتا المرور غير متطابقتين',
    alreadyHaveAccount: 'لديك حساب؟',

    // Verify email
    verifyEmailTitle: 'تأكيد بريدك الإلكتروني',
    verifyEmailSubtitle: (email: string) => `أرسلنا رمزًا مكوّنًا من 6 أرقام إلى ${email}`,
    ...
    forgotPasswordSubtitle: 'أدخل بريدك الإلكتروني وسنرسل إليه رمزًا مكوّنًا من 6 أرقام.',
    forgotPasswordSendButton: 'إرسال الرمز',
    resetPasswordTitle: 'اختر كلمة مرور جديدة',
    // Never says the code was sent — the server refuses to reveal whether the
    // address has an account, and copy that promises an email would give away
    // what the API is careful not to.
    resetPasswordSubtitle: (email: string) => `إن كان لـ ${email} حساب لدينا، فقد أرسلنا إليه رمزًا. يصلح الرمز لمدة 15 دقيقة.`,
    newPassword: 'كلمة المرور الجديدة',
    resetPasswordButton: 'تعيين كلمة المرور',
    codeResent: 'تم إرسال رمز جديد',
    invalidVerificationCode: 'رمز غير صحيح أو منتهي الصلاحية',
    emailNotVerifiedError: 'أكّد بريدك الإلكتروني قبل تسجيل الدخول',
    verifyEmailLink: 'تأكيد البريد الإلكتروني',
    wrongEmail: 'البريد الإلكتروني غير صحيح؟',
    changeEmailTitle: 'تغيير البريد الإلكتروني',
    newEmail: 'البريد الإلكتروني الجديد',
    changeEmailPasswordHint: 'أدخل كلمة المرور للتأكيد أنّ هذا حسابك',
    changeEmailButton: 'تغيير وإرسال رمز جديد',
    emailChanged: (email: string) => `تم إرسال رمز جديد إلى ${email}`,
    ...
    createHomework: 'واجب بيتي',
    openCurriculum: 'عرض المنهاج',
    curriculumShortcutTitle: 'اختصار المنهاج',
    curriculumShortcutSub: 'كل الصفوف والمواد · الفصلان الأول والثاني',
    ...
    relatedResourcesHint: 'قد يفيدك أيضًا:',
    ...
    qrLibraryEntry: 'مصادر الكتب',
    qrLibraryTitle: 'مصادر الكتب',
    qrLibraryCount: (n: number) => arCountPhrase(n, 'مصدر', 'مصدران', 'مصادر'),
    qrLibraryIntro:
      'روابطُ رموز الاستجابة السريعة المطبوعة في كتبك، مرتّبةً حسب الكتاب والصفحة. تُفتح في المتصفّح.',
    qrLibraryEmpty: 'لا توجد مصادر مطبوعة لهذا الصف.',
    qrOnPage: (page: string) => `صفحة ${page}`,
    // Said per row rather than once per screen: on a screen where one link is
    // insecure and the rest are not, a single header note tells you nothing
    // about the one you are about to tap.
    qrInsecureRow: 'رابط غير آمن (http) — شهادة موقع الوزارة منتهية',
    qrKindAll: 'الكل',
    qrKindAudio: 'صوت',
    qrKindVideo: 'فيديو',
    ...
    librarySecImage: 'صور',
    libraryCatVideo: 'فيديو',
    libraryCatAudio: 'صوت',
    libraryCatGame: 'لعبة',
    libraryCatWorksheet: 'ورقة عمل',
    libraryCatTemplate: 'قالب',
    libraryCatPresentation: 'عرض تقديمي',
    libraryCatDocument: 'مستند',
    librarySecInfographic: 'إنفوجرافيك',
    librarySecVideo: 'فيديوهات',
    librarySecAudio: 'تسجيلات صوتية',
    librarySecGame: 'ألعاب تعليمية',
    librarySecWorksheet: 'أوراق عمل',
    librarySecTemplate: 'قوالب',
    librarySecPresentation: 'عروض تقديمية',
    librarySecDocument: 'مستندات',
    libraryAddResource: 'إضافة مورد',
    libraryAdminTitle: 'إضافة مورد إلى المكتبة',
    libraryAdminGrade: 'الصف',
    libraryAdminSubject: 'المادة',
    libraryAdminScope: 'النطاق',
    libraryAdminScopeAll: 'كل الكتاب',
    libraryAdminScopeS1: 'الفصل الأول',
    libraryAdminScopeS2: 'الفصل الثاني',
    libraryAdminScopeLesson: 'درس محدد',
    libraryAdminLesson: 'الدرس',
    libraryAdminAnyLesson: 'كل دروس المادة',
    libraryAdminCategory: 'التصنيف',
    ...
    libraryAdminFileHint: 'صور، PDF، Word، PowerPoint، صوت، فيديو قصير — حتى 25 ميغابايت. للفيديو الطويل أو الألعاب الإلكترونية استخدم رابطًا.',
    libraryAdminUrl: 'الرابط (https)',
    libraryAdminSave: 'نشر في المكتبة',
    libraryAdminEditSave: 'حفظ التعديلات',
    libraryAdminSaving: 'جارٍ الرفع…',
    libraryAdminSaved: 'نُشر المورد في المكتبة',
    libraryAdminTooBig: 'الملف أكبر من 25 ميغابايت — ارفعه على يوتيوب أو Drive وأضفه كرابط.',
    libraryAdminMissing: 'أكمل الصف والمادة والعنوان، واختر ملفًا أو أدخل رابطًا.',
    libraryAdminExisting: 'المنشور لهذا الصف',
    libraryAdminDelete: 'حذف',
    ...
    // Said where the section would be, not hidden: an empty shelf with no
    // explanation reads as a broken screen.
    premadeSheetsPending: 'لم تُبنَ الأوراق الجاهزة بعد.',
    resourceKindWorksheet: 'ورقة عمل',
    resourceKindGame: 'نشاط',
    resourceKindText: 'نص',
    resourceActionPrint: 'طباعة',
    premadeSheetMeta: (n: number) => `${arCountPhrase(n, 'سؤال', 'سؤالان', 'أسئلة')} · مع مفتاح الإجابات`,
    resourceActionAddToClass: 'أضف إلى الشعبة',
    resourceActionRun: 'ابدأ النشاط',
    resourceActionOpen: 'افتح',
    ...
    unitsAndLessons: (units: number, lessons: number) =>
      `${arCountPhrase(units, 'وحدة', 'وحدتان', 'وحدات')} · ${arCountPhrase(lessons, 'درس', 'درسان', 'دروس')}`,
    ...
    learningOutcomes: 'نتاجات التعلّم',

    // AI Tools hub
    aiTools: 'أدوات التدريس',
    poweredByAI: 'بتقنية اقرأ',
    aiToolsSubtitle: 'من التحضير إلى التقويم — اختر ما تحتاجه لكل مرحلة من الحصة.',
    aiToolsNote: 'المخرجات الحالية تجريبية للعرض. التكامل الكامل قادم قريبًا.',
    chatToolsTitle: 'الأدوات',
    chatToolsFor: (topic: string) => `للدرس: ${topic}`,
    chatToolsAttachFile: 'ارفع ملفًا',
    ...
    slidesFromPromptLink: 'أو اكتب وصف العرض بكلماتك ←',
    toolPromptSlidesTitle: 'إنشاء عرض تفاعلي',
    ...
    parentMsgTitle: 'رسالة لوليّ الأمر',
    ...
    parentMsgFactsNote: 'لن تُضيف الأداة أي واقعة أو رقم لم تكتبه بنفسك — الرسالة تحمل اسمك وتصل إلى وليّ الأمر.',
    ...
    parentMsgSendInApp: 'أرسل عبر اقرأ',
    ...
    parentMsgRecipients: (names: string) => `سيصل إلى: ${names}`,
    parentMsgConfirmTitle: 'إرسال الرسالة؟',
    parentMsgConfirmSend: 'أرسل',
    parentMsgPartialSend: (sent: string, failed: string) => `وصلت الرسالة إلى ${sent}، وتعذّر إرسالها إلى ${failed}. اضغط «أرسل عبر اقرأ» مرة أخرى لإعادة المحاولة.`,
    ...
    parentMsgHistoryRecent: 'آخر 30 يومًا:',
    ...
    toolHomeworkTitle: 'واجب بيتي',
    toolHomeworkDesc: 'تمرين مستقل ينجزه الطالب في البيت دون وجودك.',
    toolExamTitle: 'ورقة امتحان',
    toolExamDesc: 'امتحان أطول للتقويم الختامي وفق معايير المنهاج.',
    toolParentMsgTitle: 'رسالة لوليّ الأمر',
    ...
    // Coming soon
    comingSoon: 'قريبًا',
    comingSoonDesc: 'هذه الأداة قيد التجهيز وستكون جاهزة قريبًا.',
    ...
    topicRequired: 'أدخل موضوع الدرس أولًا.',
    ...
    generationFailed: 'تعذّر إتمام العملية. حاول مرة أخرى.',
    ...
    curriculumUngroundedNotice: 'هذا الموضوع غير موجود في المنهاج المتاح حاليًا. الخطة عامة وليست مبنية على نتاجات درس محدد من الكتاب.',
    curriculumUngroundedNoticeWorksheet: 'هذا الموضوع غير موجود في المنهاج المتاح حاليًا. ورقة العمل عامة وليست مبنية على نتاجات درس محدد من الكتاب.',
    ...
    needTopicHint: 'اكتب عنوان الدرس أعلاه ليصبح الزر جاهزًا.',
    ...
    sectionAssessment: 'التقويم',
    sectionDifferentiation: 'التمايز',
    sectionHomework: 'الواجب البيتي',

    // Worksheet generator
    createWorksheetTitle: 'ورقة عمل',
    worksheetSubtitle: 'وثيقة تدريب للطالب داخل الصف — ليست نشاطًا جماعيًا',
    homeworkSubtitle: 'تمرين بيتي مستقل مع تعليمات واضحة وسؤال تحدٍّ اختياري',
    ...
    bookFiguresLessonNote: 'أشكالُ هذا الدرس من كتابك المدرسي، مع رقم الصفحة المطبوعة.',
    iqraWelcome: 'مرحبًا — أنا اقرأ، رفيقك في تحضير الحصص.',
    iqraWelcomeDocs: 'أنا اقرأ، رفيقك في تحضير الحصص.\n\nارفع خطة درس أو عرضًا أو ورقة عمل أو صورة من الكتاب — ونحضّر معًا التلخيص والشرح وخطط الدرس وأوراق العمل والواجبات والاختبارات من موادك.',
    ...
    iqraNoResults: 'لم أجد هذا في الكتب المتوفرة حاليًا. جرّب صياغة أخرى أو موضوعًا من المنهاج.',
    ...
    // ── Command palette (⌘K) ──────────────────────────────────────
    cmdPlaceholder: 'اكتب أمرًا، أو ابحث عن أداة…',
    cmdEmpty: 'لا نتائج',
    cmdHintOpen: 'للفتح',
    cmdHintMove: 'للتنقل',
    ...
    teaching: 'التدريس',
    notSet: 'غير محدد',
    mySubjects: 'المواد التي أُدرّسها',
    myGrades: 'الصفوف التي أُدرّسها',
    editProfile: 'تعديل الحساب',
    changePhoto: 'تغيير الصورة',
    removePhoto: 'إزالة الصورة',
    removePhotoConfirm: 'هل تريد إزالة صورة الملف الشخصي؟',
    photoUpdateFailed: 'تعذّر تحديث الصورة',
    photoRemoveFailed: 'تعذّر إزالة الصورة',
    ...
    deleteAccountWhatGoesOther: 'سيُحذف معه: رسائلك وصورك المرفقة، وارتباطك بشعبتك. يبقى سجلّ الطالب عند المعلّم لأنّه من بيانات المعلّم.',
    ...
    objectivesPlaceholder: 'اكتب أهدافك أو اترك الحقل فارغًا لاقتراحها',
    adaptationsLabel: 'تكييفات وتعليمات إضافية (اختياري)',
    adaptationsPlaceholder: 'مثال: كيّف الخطة لطالب لديه فرط حركة وتشتت انتباه',
    adaptationSimplifyChip: 'بسّط الشرح',
    adaptationSimplifyPreset: 'بسّط اللغة واجعل الخطوات أقصر، واربط الفكرة بمثال من حياة الطلبة، وتجنّب المصطلحات المعقّدة.',
    priorTopicsLabel: 'موضوعات سابقة لإعادة شرحها (اختياري)',
    priorTopicsPlaceholder: 'مثال: بعض الطلبة لم يستوعبوا حل المعادلات من الصف التاسع — راجعها قبل الدرس الجديد',
    ...
    entireBook: 'الكتاب كاملًا',
    entireUnit: 'الوحدة كاملةً',
    ...
    selectAtLeastOneType: 'اختر نوع سؤال واحدًا على الأقل',
    pts: 'نقطة',
    marksEach: 'لكل سؤال',
    totalLabel: 'المجموع',
    ...
    exportCopy: 'نسخ النص',
    exportCopySub: 'انسخ المحتوى كاملًا',
    exportPDF: 'تصدير PDF',
    ...
    activityObjectivePlaceholder: 'ماذا يستطيع الطلبة بعد هذا النشاط؟',
    ...
    toolLessonFlowSub: 'ابنِ تسلسل الحصة كاملًا دفعة واحدة — تحضير متقدم.',
    ...
    lessonFlowLaunchClassroom: 'اعرض على شاشة الصف',
    ...
    toolClassroomTitle: 'الحصة التفاعلية',
    toolClassroomDesc: 'أنشطة مباشرة على الشاشة — ألعاب وتحديات مع مؤقت.',
    classroomBadge: 'عرض مباشر',
    classroomHubTitle: 'الحصة التفاعلية',
    classroomHubSubtitle: 'أنشطة مباشرة',
    classroomHubDesc: 'شغّل أنشطة تفاعلية مباشرة في الصف',
    ...
    faqA3: 'خطة درس، ورقة عمل، واجب بيتي، اختبار قصير، نشاط صفي، وتبسيط الشرح — كلها من زر ➕. ما يمكن للمحادثة إنتاجه يظهر مباشرة في المحادثة، وما يحتاج شاشة خاصة (وضع الحصة، مسار الدرس، جيوجبرا) ينتقل إليها ومعه الدرس الحالي.',
    ...
    faqQ8: 'ما فائدة الشُّعَب والطلبة؟',
    ...
    graphEmptyHint: 'لم نجد اقترانًا في هذا الدرس — اكتب أي معادلة في الحاسبة أمام الطلبة.',
    ...
    activityQuickCheckDesc: 'أسئلة على الشاشة يجيب عنها كل الطلبة معًا برفع الأيدي — بلا تحضير مسبق',
    ...
    activityBingoDesc: 'استدعِ المصطلحات وشطّب المربعات — أول من يكمل صفًا يفوز',
    ...
    loadDemoData: 'حمّل محتوى تجريبيًا',
    ...
    promptSlidesPlaceholder: 'مثال: 6 شرائح عن التمثيل الضوئي للصف السادس، بأسلوب ممتع، مع سؤالي تحقق',
    promptRequired: 'اكتب وصفًا للعرض أولًا.',
    promptSlidesBuild: 'جهّز الشرائح',
    promptSlidesBuilding: 'جارٍ التجهيز…',
    promptSlidesAsking: 'أقرأ وصفك…',
    promptSlidesBuildWithAnswers: 'جهّز الشرائح',
    promptSlidesSkipQuestions: 'تخطَّ الأسئلة وجهّز الآن',
    promptSlidesSlideCountLabel: 'عدد الشرائح (اختياري، حتى 20)',
    promptSlidesFieldLabel: 'وصف العرض',
    promptSlidesSourceToggle: 'ألصق نصًا مصدريًا (اختياري)',
    promptSlidesSourceLabel: 'النص المصدري',
    promptSlidesSourcePlaceholder: 'ألصق هنا نص الدرس أو المقال أو ملاحظاتك — ستُبنى الشرائح منه بدل الاعتماد على معلومات النموذج.',
    promptSlidesSourceHint: 'الصق النص كما هو. الملفات (PDF وWord وPowerPoint) لا تُقرأ بعد على كل الأجهزة، أمّا النص الملصوق فيعمل دائمًا.',
    promptSlidesSourceCount: (n: number, max: number) => `${n} من ${max} حرف`,
    promptSlidesPillSlides: 'حتى 20 شريحة',
    promptSlidesPillImages: 'صور مولّدة',
    promptSlidesPillExport: 'PDF و PPTX',
    promptSlidesEmptyTitle: 'ابدأ فكرتك هنا',
    promptSlidesEmptyHint: 'اكتب وصف العرض في الأعلى، ثم اضغط «جهّز الشرائح».',
    // Class Challenge (phone-free team game)
    gameTitle: 'تحدي الصف',
    gameSubtitle: 'لعبة أسئلة بين فرق الصف — بدون هواتف للطلبة. الشاشة هي لوحة اللعب.',
    ...
    gameTeamsReady: (n: number) => arCountPhrase(n, 'فريق واحد', 'فريقان', 'فرق'),
    ...
    buildActivityFirst: 'جهّز نشاطًا أولًا',

    // Roster — classes and students
    classes: 'الشُّعَب',
    myClasses: 'شُعَبي',
    newClass: 'شعبة جديدة',
    createClass: 'أنشئ الشعبة',
    editClass: 'تعديل الشعبة',
    className: 'اسم الشعبة',
    classNamePlaceholder: 'مثال: العاشر رياضيات أ',
    noClassesYet: 'لا شُعَب بعد',
    noClassesDesc: 'أنشئ شعبةً وأضف طلبتك لتتمكّن من تقييم مستواهم',
    studentsCount: 'طالبًا',
    noStudentsYet: 'لا طلبة في هذه الشعبة',
    noStudentsDesc: 'أضف أسماء طلبتك — يمكنك لصق القائمة كاملة دفعة واحدة',
    addStudents: 'أضف طلبةً',
    studentNames: 'أسماء الطلبة',
    studentNamesPlaceholder: 'اسم في كل سطر، أو افصل بينها بفاصلة',
    studentNamesHint: 'الصق قائمة أسماء — سطر لكل طالب',
    addStudentsCodeHint: 'بعد الإضافة، اضغط «رمز الربط» في صفحة الشعبة وشاركه مع أولياء الأمور والطلبة، وسيختار كلٌّ منهم اسمه من قائمة الشعبة عند التسجيل.',
    ...
    addToClass: 'أضف إلى الشعبة',
    removeStudent: 'أزل من الشعبة',
    removeStudentConfirm: (name: string) => `إزالة ${name} من هذه الشعبة؟ سيبقى سجلّه محفوظًا.`,
    deleteClass: 'أرشفة الشعبة',
    archive: 'أرشِف',
    ...
    deleteClassConfirm: (name: string) =>
      `أرشفة «${name}»؟ ستختفي الشعبة من قائمتك، وتبقى سجلّات الطلبة والمواد المرتبطة بها محفوظة.`,
    studentsAdded: (n: number) => `تمت إضافة ${arCountStudents(n)}`,
    noNewStudents: 'لا أسماء جديدة لإضافتها',
    skippedExisting: (names: string) => `موجودون في الشعبة مسبقًا، لم تُضف: ${names}`,
    rosterNeedsConnection: 'قائمة الطلبة تحتاج اتصالًا بالخادم',
    rosterStorageUnavailable: 'سجل الشُّعَب غير مُهيَّأ على الخادم بعد. تواصل مع مسؤول النظام لتفعيله.',
    rosterCreateFailed: 'تعذّر إنشاء الشعبة. حاول مرة أخرى.',
    rosterLoadFailed: 'تعذّر تحميل الشُّعَب.',
    remove: 'إزالة',

    // Teaching plans — a teacher's own notes on what they intend to teach
    myTeachingPlans: 'خطط التدريس',
    newTeachingPlan: 'خطة تدريس جديدة',
    editTeachingPlan: 'تعديل خطة التدريس',
    saveTeachingPlan: 'حفظ',
    planTitle: 'عنوان الخطة',
    planTitlePlaceholder: 'مثال: خطة الفصل الأول',
    schoolNamePlaceholder: 'اسم المدرسة',
    planClass: 'الشعبة',
    planNoClass: 'بدون شعبة',
    planScope: 'الصف والمادة',
    planScopeFromClass: 'يُؤخذان من الشعبة',
    planNeedsClass: 'كل خطة مرتبطة بشعبة، ومنها يأخذ التطبيق الصف والمادة. أنشئ شعبة أولًا.',
    planLegacyGrades: (v: string) => `أُدخل سابقًا: ${v}`,
    planSchedule: 'الجدول الزمني',
    planScheduleHint: 'اضبط تاريخ البداية وأيام الدوام ثم اضغط «توزيع تلقائي» لتوزيع الدروس، أو حدّد تاريخ كل درس يدويًا أدناه.',
    planNoLessons: 'لا توجد دروس في المنهاج لهذه الشعبة بعد.',
    planPeriodsCount: (n: number) => arCountPhrase(n, 'حصة', 'حصتان', 'حصص'),
    planLessonsCount: (n: number) => arCountPhrase(n, 'درس', 'درسان', 'دروس'),
    planStartDate: 'ابتداءً من',
    planMeetingDays: 'أيام الدوام',
    planAutoSchedule: 'توزيع تلقائي',
    planAutoScheduleTitle: 'استبدال الجدول الحالي؟',
    planAutoScheduleConfirm: 'سيُعاد توزيع كل الدروس على التواريخ الجديدة، وستُفقد التعديلات اليدوية على الجدول الحالي.',
    planAutoScheduleAction: 'توزيع',
    planWeekdaySun: 'أحد',
    planWeekdayMon: 'اثنين',
    planWeekdayTue: 'ثلاثاء',
    planWeekdayWed: 'أربعاء',
    planWeekdayThu: 'خميس',
    planWeekdayFri: 'جمعة',
    planWeekdaySat: 'سبت',
    planTodayLesson: (title: string) => `اليوم: ${title}`,
    planNextLesson: (date: string, title: string) => `القادم (${date}): ${title}`,
    planGrades: 'الصفوف',
    planGradesPlaceholder: 'مثال: التاسع، العاشر',
    planTopics: 'المواضيع',
    planTopicsPlaceholder: 'المواضيع التي ستُدرَّس',
    planDatePlaceholder: 'مثال: 2026-10-01',
    planTime: 'الوقت',
    planTimePlaceholder: 'مثال: الأحد والثلاثاء 8-9 صباحًا',
    planNotesPlaceholder: 'ملاحظات إضافية',
    noTeachingPlansYet: 'لا خطط تدريس بعد',
    noTeachingPlansDesc: 'أنشئ خطةً تحفظ فيها المدرسة والصفوف والمواضيع والوقت',
    deleteTeachingPlan: 'حذف الخطة',
    deleteTeachingPlanConfirm: (title: string) => `حذف «${title}»؟ ستُؤرشَف الخطة وتختفي من قائمتك.`,
    teachingPlansNeedsConnection: 'خطط التدريس تحتاج اتصالًا بالخادم',
    teachingPlansStorageUnavailable: 'سجل خطط التدريس غير مُهيَّأ على الخادم بعد. تواصل مع مسؤول النظام لتفعيله.',
    teachingPlansCreateFailed: 'تعذّر إنشاء الخطة. حاول مرة أخرى.',
    ...
    scheduleNeedsConnection: 'الجدول الأسبوعي يحتاج اتصالًا بالخادم',
    scheduleViewTable: 'الجدول',
    scheduleViewDay: 'اليوم',
    scheduleViewCards: 'البطاقات',
    ...
    scheduleNewSchoolTitle: 'إضافة مدرسة',
    scheduleNow: 'الآن',
    scheduleFreePeriod: 'فراغ',
    scheduleTapToAssign: 'اضغط لتعيين شعبة',
    ...
    noExamsYet: 'لا امتحانات لهذه الشعبة',
    noExamsDesc: 'أرفق امتحانًا أنشأته ليظهر هنا، وابدأ إدخال العلامات',
    attachExam: 'أرفق امتحانًا',
    attachExamHint: 'اختر من امتحاناتك غير المرتبطة بشعبة',
    noExamsToAttach: 'كل امتحاناتك مرتبطة بشُعَب أخرى',
    noExamsAtAll: 'لا امتحانات بعد — أنشئ امتحانًا أولًا',
    createNewExam: 'أنشئ امتحانًا',
    detachExam: 'أزل من الشعبة',
    examMarkedCount: (marked: string, total: string) => `صُحّح ${marked} من ${total}`,
    examNotPublished: 'مسودّة — انشره قبل إدخال العلامات',
    masteryTitle: 'ما يحتاج مراجعة',
    masteryBasis: (exams: string) => `مبنيّ على ${exams}`,
    masteryEmpty: 'لا نتائج مرصودة بعد',
    ...
    // per-student record, and is named from that side of the app.
    ...
    miniEvalNoObjectives: 'لا أهداف متاحة لهذه الشعبة — اختر المنهاج من شاشة الامتحان الكامل',
    miniEvalGenerate: 'ولّد الأسئلة',
    miniEvalGenerating: 'جارٍ توليد الأسئلة…',
    miniEvalReviewHint: 'راجع الأسئلة الثلاثة قبل نشرها لطلبتك',
    miniEvalPublish: 'انشر وشارك الرابط',
    ...
    changeClass: 'تغيير',
    choose: 'اختر',
    removeFromClass: 'بلا شعبة',
    removedFromClass: 'أُزيلت من الشعبة',
    notNow: 'ليس الآن',
    savedToClass: (name: string) => `حُفظت في ${name}`,
    savedToClasses: (classes: string) => `حُفظت في ${classes} — نسخة مستقلة لكل شعبة`,
    ...
    evaluationsSubtitle: 'امتحان يُرصَد ويُصحَّح: ولّد أسئلته من المنهاج وشاركه برابط وصحّح إجابات طلبتك',
    ...
    evalStatusDraft: 'مسودّة',
    evalStatusPublished: 'منشور',
    evalStatusClosed: 'مغلق',
    evalQuestionCount: (n: number) => arCountPhrase(n, 'سؤال', 'سؤالان', 'أسئلة'),
    evalTotalMarks: (n: string) => `${n} علامة`,
    evalRowQuestions: (n: number) => arCountPhrase(n, 'سؤال', 'سؤالان', 'أسئلة'),
    evalRowMarked: (n: number) => `صُحّحت ${arCountPhrase(n, 'ورقة', 'ورقتان', 'أوراق')}`,
    evalRowNoneMarked: 'لم تُصحَّح أي ورقة بعد',
    ...
    typeDictation: 'إملاء',
    readAloudStart: 'ابدأ التسجيل',
    readAloudStop: (elapsed: string) => `إيقاف (${elapsed})`,
    readAloudUploading: 'جارٍ الرفع…',
    readAloudHeard: 'ما سمعناه:',
    readAloudTakesLeft: (n: string) => `تبقّى لديك ${n} من المحاولات`,
    readAloudNoTakesLeft: 'استخدمتَ جميع محاولات التسجيل لهذا السؤال.',
    readAloudNoMic: 'تعذّر الوصول إلى الميكروفون. اسمح للمتصفّح باستخدامه ثمّ أعد المحاولة.',
    readAloudFailed: 'تعذّر حفظ التسجيل. أعد المحاولة.',
    readAloudWebOnly: 'يعمل التسجيل في المتصفّح فقط. افتح رابط الاختبار في متصفّح لتسجيل إجابتك.',
    shelfExternal: (n: string) => `مصادر خارجية مرخّصة (${n})`,
    marksLabel: 'العلامة',
    lessonMediaTitle: 'شاهِدْ',
    practiceTitle: 'تدرَّبْ على القراءة الجهرية',
    practiceIntro: 'اقرأِ النصَّ بصوتٍ مسموع، واستمعْ إلى نفسِك، وأعِدْ كما تشاء. لا تُرصَد أيُّ علامة.',
    practiceScoring: 'جارٍ التقييم…',
    practiceTryAgain: 'أعِدْ المحاولة',
    ...
    readAloudPassageLabel: 'النصّ المطلوب قراءتُه',
    readAloudPassageHint:
      'الصِق نصًّا إنجليزيًّا حقيقيًّا — من المصادر المرخّصة في رفّ الدرس أو من الكتاب. لا يكتب الذكاء الاصطناعي هذه النصوص.',
    readAloudWordCount: (n: string, min: string, max: string) => `${n} كلمة (المطلوب بين ${min} و${max})`,
    readAloudObjectiveLabel: 'النتاج الذي يقيسه',
    readAloudObjectiveN: (n: string) => `النتاج ${n}`,
    readAloudCompetencyLabel: 'الكفاية',
    addReadAloudBtn: 'أضِف سؤال قراءة جهرية',
    dictationAddTitle: 'إضافة إملاء',
    dictationAddBtn: (n: string) => `أضِف ${n} سؤالًا`,
    dictationAddProgress: (done: string, total: string) => `تُضاف... ${done} من ${total}`,
    dictationAddFailed: 'تعذّرت إضافة الأسئلة.',
    dictationAddPartial: (done: string, total: string) =>
      `أُضيف ${done} من ${total}. الباقي لم يُضَف — أعِد المحاولة بالكلمات المتبقّية فقط.`,
    dictationReadAloudNote:
      'يُمْلي المعلّمُ الكلماتِ بصوتِه. تظهرُ الكلماتُ في قائمةِ الأسئلةِ ليقرأَها أمامَ الصفّ.',
    dictationSourceRule: 'مِنْ قواعدِ الإملاء في المنهاج',
    dictationSourceOwn: 'كلماتي',
    dictationRuleLabel: 'القاعدة',
    dictationRuleGrades: (grades: string) => `الصفوف ${grades}`,
    dictationCountLabel: 'عددُ الأسئلة',
    dictationOwnWordsLabel: 'الكلماتُ أو الجُمَل',
    dictationOwnWordsHint:
      'كلمةٌ أو جملةٌ في كلِّ سطر، مشكولةً كما في الكتاب. يكتبُ الطالبُ ما يسمعُه.',
    dictationPreviewLabel: (n: string) => `ما سيُضاف (${n})`,
    dictationMarksEachLabel: 'علاماتُ كلِّ سؤال',
    addDictationBtn: 'أضِف إملاء',
    addOwnQuestionBtn: 'أضِف سؤالًا من إعدادك',
    questionAddTitle: 'سؤال من إعدادك',
    questionEditTitle: 'تعديل السؤال',
    questionEditBtn: 'عدّل السؤال',
    questionDeleteBtn: 'احذف السؤال',
    questionDeleteConfirm: 'حذف هذا السؤال؟',
    questionTypeLabel: 'نوع السؤال',
    questionStemLabel: 'نصّ السؤال',
    questionStatementLabel: 'العبارة',
    questionOptionsLabel: 'الخيارات — اضغط الدائرة لتحديد الإجابة الصحيحة',
    questionOptionN: (n: string) => `الخيار ${n}`,
    questionAnswerLabel: 'الإجابة الصحيحة',
    questionBlankTextHint: 'اكتب ____ (شرطات سفلية) مكان كل فراغ.',
    questionBlankN: (n: string) => `إجابة الفراغ ${n} — افصل الإجابات المقبولة بـ /`,
    questionPairsLabel: 'الأزواج — اترك الجهة الأولى فارغة لإضافة خيار مُشتِّت',
    questionAddPair: 'أضِف زوجًا',
    questionScenarioLabel: 'الموقف أو المعطيات',
    questionModelAnswerLabel: 'الإجابة النموذجية',
    questionKeyConceptsLabel: 'الأفكار الرئيسة (فكرة في كل سطر)',
    questionCriteriaLabel: 'معايير النجاح (معيار في كل سطر)',
    questionSaveBtn: 'احفظ',
    questionSaveFailed: 'تعذّر حفظ السؤال.',
    regenerateKeepsOwnNote: 'ستُستبدل الأسئلة المولَّدة، ومنها ما عدّلتَه. تبقى الأسئلة التي كتبتَها بنفسك.',
    dictationPlay: 'استمعْ',
    dictationPlaying: 'يُشغَّل…',
    dictationPlaysLeft: (n: string) => `بقيَ لكَ ${n} استماعات`,
    dictationNoPlaysLeft: 'انتهتْ مرّاتُ الاستماع. اطلبْ مِنْ معلّمِكَ أنْ يُعيدَ الكلمةَ.',
    dictationListenToTeacher: 'يقرأُ المعلّمُ الكلمةَ بصوتِه. استمعْ جيّدًا ثُمَّ أجِبْ.',
    dictationWebOnly: 'لتشغيلِ الصوتِ افتحِ الامتحانَ في المتصفّح. أوِ استمعْ إلى معلّمِك.',
    dictationTapCorrect: 'اختَرِ الكِتابَةَ الصَّحيحَةَ:',
    dictationWriteWhatYouHear: 'اكتُبْ ما تسمعُ:',
    dictationWritePlaceholder: 'اكتُبِ الكلمةَ هنا',
    shelfEmbedOnly: 'للعرض فقط — لا يجوز نسخُه.',
    ...
    enterAnswersBtn: 'أدخل إجابات الطلبة',
    pickStudentTitle: 'اختر طالبًا',
    pickClassFirst: 'اختر الشعبة',
    ...
    shareExamTitle: 'رابط الطلبة',
    shareExamHint: 'اكتب الرمز على اللوح، أو أرسل الرابط. يفتحه الطالب ويختار اسمه.',
    shareExamNeedsClass: 'أرفق هذا الامتحان بشعبة أولًا — الطالب يختار اسمه من قائمة الشعبة.',
    shareExamCopyLink: 'انسخ الرابط',
    shareExamAttachNow: 'أرفقه بشعبة الآن',
    ...
    classGapWorksheet: 'جهّز ورقة عمل للشعبة',
    ...
    scanBudgetSpent: 'انتهى رصيد الذكاء الاصطناعي لهذا الشهر. أدخل العلامات يدويًا.',
    ...
    gradedCountLabel: (n: number, total: number) => `قُيِّم ${n} من ${arCountStudents(total)}`,
    ...
    onboardingSlide1Desc: 'اقرأ يتبع كتب المنهاج الأردني بوحداتها ودروسها: المعلم يحضّر حصصه، والأهل والطلبة يتابعون شعبتهم.',
    onboardingSlide1Points: 'من الصف الأول إلى العاشر\nوحدات الكتاب المدرسي ودروسه\nبالعربية وبالإنجليزية',
    onboardingSlide6Title: 'اسأل «اقرأ» عن أي درس',
    onboardingSlide6Desc: 'مساعد يعرف كتب المنهاج: اسأله عن درس أو فكرة للشرح، ويدلّك على الأداة المناسبة بزرّ واحد.',
    onboardingSlide6Points: 'إجابات من كتب المنهاج\nأفكار للشرح والتمهيد\nيدلّك على الأداة المناسبة',
    onboardingSlide2Title: 'رحلة حصة كاملة في مسار واحد',
    onboardingSlide2Desc: 'من الأهداف والتمهيد، إلى النشاط والتدريب وورقة العمل وبطاقة الخروج — تُبنى بالتتابع، لا قطعًا متفرقة.',
    onboardingSlide2Points: 'الأهداف والتمهيد\nالنشاط والتدريب\nورقة العمل وبطاقة الخروج',
    onboardingSlide4Title: 'أدوات لكل لحظة في الحصة',
    onboardingSlide4Desc: 'شرائح تعرضها على السبورة، وتحدٍّ جماعي بلا هواتف، وأشكال من كتابك برقم صفحتها — جاهزة قبل الحصة وأثناءها.',
    onboardingSlide4Points: 'شرائح للعرض\nتحدٍّ جماعي بلا هواتف\nأشكال الكتاب برقم الصفحة',
    onboardingSlide7Title: 'أوراق عمل وبطاقات خروج في دقيقة',
    onboardingSlide7Desc: 'ورقة عمل بمستويات صعوبة ومفتاح إجابة، وبطاقة خروج تعرف بها ما فهمه طلبتك قبل أن يغادروا الصف.',
    onboardingSlide7Points: 'مستويات صعوبة متدرّجة\nمفتاح إجابة جاهز\nبطاقة خروج لآخر الحصة',
    onboardingSlide8Title: 'اختبار يجيب عنه الطلبة من هواتفهم',
    onboardingSlide8Desc: 'ولّد الاختبار من الدرس وشاركه برابط، فيجيب الطلبة من هواتفهم، وتُرصد علاماتهم وتصلك نتائج كل طالب.',
    onboardingSlide8Points: 'أسئلة من المنهاج\nمشاركة برابط\nرصد العلامات والنتائج',
    onboardingSlide9Title: 'شُعبك وجدولك في مكان واحد',
    onboardingSlide9Desc: 'أضف شُعبك وجدول حصصك الأسبوعي، وخطة تدريس تقول لك ماذا تدرّس لكل شعبة ومتى.',
    onboardingSlide9Points: 'شُعب برمز ربط\nجدول الحصص الأسبوعي\nخطة تدريس لكل شعبة',
    onboardingSlide5Title: 'للأهل والطلبة أيضًا',
    onboardingSlide5Desc: 'أدخل رمز الربط من المعلم لتربط حسابك بالشعبة، فتصلك رسائل المعلم وإشعاراته، وتتصفح المنهاج متى شئت.',
    onboardingSlide5Points: 'رمز ربط من المعلم\nرسائل المعلم وإشعاراته\nالمنهاج متى شئت',
    ...
    messagingEmptyDesc: 'ابدأ محادثة مع معلم أو وليّ أمر مرتبط بحسابك',
    messagingEmptyDescTeacher: 'ابدأ محادثة مع وليّ أمر أو طالب مرتبط بشعبتك.',
    messagingNewMessage: 'رسالة جديدة',
    messagingCreateGroupError: 'تعذّر إنشاء المجموعة. حاول مرة أخرى.',
    messagingLoadError: 'تعذّر تحميل المحادثات',
    messagingSendError: 'تعذّر إرسال الرسالة',
    messagingImageSaveFailed: 'تعذّر حفظ الصورة',
    ...
    messagingClaimCodeTitle: 'رمز الربط لهذا الطالب',
    messagingClaimCodeDesc: 'رمز لهذا الطالب وحده. في الغالب يكفي رمز الربط الخاص بالشعبة — استخدم هذا الرمز فقط إن أردت ربط وليّ أمر بهذا الطالب تحديدًا.',
    messagingGenerateCode: 'إنشاء رمز جديد',
    messagingCreateCode: 'أنشئ الرمز',
    messagingShareCode: 'شارك الرمز',
    messagingCodeShared: 'تمت مشاركة الرمز',
    messagingNoCodeYet: 'لا يوجد رمز فعّال لهذا الطالب بعد.',
    messagingRegenerateCode: 'استبدل الرمز برمز جديد',
    messagingRegenerateWarnTitle: 'استبدال الرمز الحالي؟',
    messagingRegenerateWarnBody:
      'سيتوقّف الرمز الحالي عن العمل فورًا. إن كنت قد شاركته مع وليّ أمر أو طالب ولم يُنشئ حسابه بعد، فسيحتاج إلى الرمز الجديد.',
    messagingRegenerateConfirm: 'استبدال',
    messagingStudentAccountsOffTitle: 'حسابات الطلبة وأولياء الأمور غير مفعّلة',
    messagingStudentAccountsOffBody:
      'لا يمكن إنشاء حساب طالب أو وليّ أمر في هذه النسخة، فلا يوجد ما يستفيد من رمز الربط الآن. قائمة شعبتك وملاحظاتك تبقى كما هي.',
    messagingCodeExpires: 'ينتهي في',
    messagingCopyCode: 'انسخ الرمز',
    ...
    messagingNoContactsDesc:
      'لا يملك الطلبة في قائمتك حسابات بعد. افتح شعبتك واضغط «رمز الربط»، ثم شارك الرمز مع أولياء الأمور والطلبة لينشئوا حساباتهم.',
    messagingDisabledDesc: 'المراسلة داخل التطبيق غير مفعّلة في هذه النسخة.',
    messagingClassChat: 'محادثة الشعبة',
    joinCodeTitle: 'رمز الربط',
    joinCodeDesc: 'رمز واحد للشعبة كلها. شاركه مع أولياء الأمور والطلبة، ويختار كل واحد اسمه من قائمة الشعبة عند إنشاء حسابه.',
    joinCodeGenerate: 'أنشئ رمز الربط',
    joinCodeRegenerate: 'أنشئ رمزًا جديدًا',
    joinCodeRegenerateConfirm: 'سيتوقف الرمز الحالي عن العمل فورًا، ولن يتمكن من لم ينضم بعد من استخدامه. هل تريد المتابعة؟',
    joinCodeShare: 'شارك الرمز',
    ...
    joinAnotherClass: 'الانضمام إلى شعبة أخرى',
    joinAnotherClassDesc: 'أدخل رمز ربط آخر لإضافة ارتباط جديد — لطفل آخر، أو وليّ أمر آخر لنفس الطفل، أو معلم آخر.',
    joinAnotherClassSubmit: 'انضمام',
    joinAnotherClassSuccess: 'تم الانضمام إلى الشعبة بنجاح',
    joinAnotherClassDone: 'تم',
    joinAnotherClassFailed: 'تعذّر الانضمام إلى هذه الشعبة',
    ...
    claimRequiredTitleStudent: 'اربط حسابك بشعبتك',
    ...
    claimRequiredSwitchNote: 'يمكن تغيير النوع الآن فقط — قبل ربط الحساب بأي شعبة.',
    ...
    teacherSetupTitle: 'ماذا تُدرّس؟',
    teacherSetupDesc: 'اختر الصفوف والمواد التي تُدرّسها لنُظهر لك المنهاج الخاص بها فقط. يمكنك تغيير هذا أو إضافة المزيد لاحقًا من حسابك.',
    teacherSetupGradesLabel: 'الصفوف',
    teacherSetupSubjectsLabel: 'المواد',
    teacherSetupContinue: 'متابعة',
    teacherSetupSave: 'حفظ',
    teacherSetupPickAtLeastOne: 'اختر مادة واحدة على الأقل لكل صف أضفته',
    teacherSetupFailed: 'تعذّر حفظ الصفوف والمواد. حاول مرة أخرى.',
    teacherSetupAddGrade: 'إضافة صف',
    teacherSetupNoGradesYet: 'اختر صفًا من الأسفل لتبدأ',
    teacherSetupRemoveGrade: (gradeName: string) => `إزالة ${gradeName}`,
    editTeachingTitle: 'الصفوف والمواد',
    rosterLinked: 'انضم',
    rosterNotLinked: 'لم ينضم بعد',
    unlinkAccount: 'إلغاء الربط',
    unlinkAccountConfirm: 'سيتم فصل هذا الحساب عن الطالب، وسيخرج من محادثات الشعبة. هل تريد المتابعة؟',
    messagingBlock: 'حظر',
    ...
    playHubSubtitle: 'العب وتعلّم — مجانًا وبدون تسجيل',
    ...
    hubFlashcards: 'بطاقات الكلمات',
    hubFlashcardsDesc: 'اسمع الكلمة واقلب البطاقة لترى معناها',
    hubListen: 'اسمع واختر',
    hubListenDesc: 'اسمع الكلمة واختر الصحيحة',
    hubMatch: 'طابِق المعنى',
    hubMatchDesc: 'طابِق كل كلمة إنجليزية بمعناها',
    hubSpell: 'تهجّى الكلمة',
    hubSpellDesc: 'اسمع الكلمة واكتبها',
    hubScramble: 'رتّب الحروف',
    hubScrambleDesc: 'اسمع الكلمة ورتّب حروفها',
    hubPicture: 'طابِق الصورة',
    hubPictureDesc: 'طابِق كل صورة بكلمتها الإنجليزية',
    hubSpeaking: 'انطق الكلمة',
    hubSpeakingDesc: 'اسمع الكلمة، سجّل صوتك وأنت تقولها، ثم استمع لنفسك',
    hubRecord: 'سجّل',
    hubStopRecording: 'أوقف التسجيل',
    hubRecording: 'جارٍ التسجيل…',
    hubTapMicToRecord: 'اضغط على الميكروفون وقُل الكلمة',
    hubHearYourself: 'اضغط على ▶ لتسمع صوتك',
    hubMicDenied: 'يحتاج هذا إلى إذن الميكروفون — اطلب من أحد الوالدين تفعيله من الإعدادات',
    hubDailyGoalDone: 'أحسنت! تدرّبت اليوم',
    hubDailyGoalTodo: 'تدرّب اليوم لتحافظ على تتابعك',
    hubRemindMe: 'ذكّرني بالتدرّب يوميًا',
    hubBadgeFirstStar: 'أول نجمة',
    hubBadgePerfectRound: 'جولة كاملة',
    hubBadgeTenStars: '10 نجوم',
    hubBadgeThreeDayStreak: 'تتابع 3 أيام',
    hubBadgeFiveLessons: '5 دروس',
    hubBadgeWeekStreak: 'تتابع أسبوع',
    hubBadgeFiftyStars: '50 نجمة',
    hubTapToFlip: 'اضغط لقلب البطاقة',
    hubNext: 'التالي',
    hubPrev: 'السابق',
    hubHear: 'اسمع',
    hubCheck: 'تحقّق',
    hubCorrect: 'أحسنت! ✔',
    hubWrong: (w: string) => `الإجابة الصحيحة: ${w}`,
    hubTypeHere: 'اكتب الكلمة هنا',
    hubQuestion: (i: number, n: number) => `${i} من ${n}`,
    hubDone: 'انتهيت!',
    hubScore: (c: number, n: number) => `أجبت إجابة صحيحة عن ${c} من ${n}`,
    hubMoves: (n: number) => `المحاولات: ${n}`,
    ...
    playSubtractTitle: 'تحدّي الطرح',
    playSubtractDesc: 'كم مسألة طرح تحلّ قبل انتهاء الوقت؟',
    playDrillPickNumbersMax: 'الأعداد حتى',
    ...
    iqraDrillNumbersUpTo: (max: number) => `الأعداد حتى ${max}`,
  ...
  en: {
    appName: 'Iqraa',
    appTagline: 'Your lesson-prep companion',
    ...
    loginValueProp: 'An Arabic platform to prepare lessons and track your students, built on the Jordanian curriculum',
    ...
    signIn: 'Sign in',
    orDivider: 'OR',
    newToIqra: 'New to Iqraa?',
    createAccount: 'Create account',

    createYourAccount: 'Create your account',
    registerSubtitle: "Join Iqraa's community of teachers in Jordan",
    fullName: 'Full name',
    ...
    verifyEmailSubtitle: (email: string) => `We sent a 6-digit code to ${email}`,
    ...
    forgotPasswordSubtitle: "Enter your email and we'll send you a 6-digit code.",
    forgotPasswordSendButton: 'Send code',
    resetPasswordTitle: 'Choose a new password',
    resetPasswordSubtitle: (email: string) => `If ${email} has an account with us, we have sent it a code. It expires in 15 minutes.`,
    newPassword: 'New password',
    resetPasswordButton: 'Set password',
    codeResent: 'A new code was sent',
    invalidVerificationCode: 'Invalid or expired code',
    emailNotVerifiedError: 'Verify your email before signing in.',
    verifyEmailLink: 'Verify email',
    wrongEmail: 'Wrong email address?',
    changeEmailTitle: 'Change email address',
    newEmail: 'New email address',
    changeEmailPasswordHint: 'Enter your password to confirm this is your account',
    changeEmailButton: 'Change and send a new code',
    emailChanged: (email: string) => `A new code was sent to ${email}`,
    memberSince: 'Member since',
    demoModeBadge: 'Demo mode · sample content',
    demoModeHint: 'Sample content for the demo — no AI model is called',
    aiLiveBadge: 'Live AI',
    aiFallbackBadge: 'Connection failed · sample content',
    aiSavedCopyBadge: "Saved copy · this month's AI allowance is used up",
    ...
    // Homepage AI-first (Phase 4)
    homeHeroTitle: "What are we preparing for today's lesson?",
    homeHeroSubtitle: 'Write what you need and Iqraa prepares the materials in minutes.',
    homeHeroPlaceholder: 'Example:\nCreate a lesson plan about solving quadratic equations',
    homeGenerate: 'Create',
    homeAiToolsTitle: 'Preparation steps',
    ...
    noSubjectsFound: 'No subjects match your search',
    qrLibraryEntry: 'Book resources',
    qrLibraryTitle: 'Book resources',
    qrLibraryCount: (n: number) => `${n} resource${n === 1 ? '' : 's'}`,
    qrLibraryIntro:
      "The QR-code links printed in your books, by book and page. They open in your browser.",
    qrLibraryEmpty: 'No printed resources for this grade.',
    qrOnPage: (page: string) => `Page ${page}`,
    qrInsecureRow: 'Insecure link (http) — the ministry site’s certificate has expired',
    qrKindAll: 'All',
    qrKindAudio: 'Audio',
    qrKindVideo: 'Video',
    ...
    librarySecImage: 'Photos',
    libraryCatVideo: 'Video',
    libraryCatAudio: 'Audio',
    libraryCatGame: 'Game',
    libraryCatWorksheet: 'Worksheet',
    libraryCatTemplate: 'Template',
    libraryCatPresentation: 'Presentation',
    libraryCatDocument: 'Document',
    librarySecInfographic: 'Infographics',
    librarySecVideo: 'Videos',
    librarySecAudio: 'Audio',
    librarySecGame: 'Games',
    librarySecWorksheet: 'Worksheets',
    librarySecTemplate: 'Templates',
    librarySecPresentation: 'Presentations',
    librarySecDocument: 'Documents',
    libraryAddResource: 'Add resource',
    libraryAdminTitle: 'Add a resource to the library',
    libraryAdminGrade: 'Grade',
    libraryAdminSubject: 'Subject',
    libraryAdminScope: 'Scope',
    libraryAdminScopeAll: 'Whole book',
    libraryAdminScopeS1: 'Semester 1',
    libraryAdminScopeS2: 'Semester 2',
    libraryAdminScopeLesson: 'Specific lesson',
    ...
    libraryAdminFile: 'Upload file',
    libraryAdminLink: 'Link',
    libraryAdminPickFile: 'Choose a file',
    libraryAdminFileHint: 'Images, PDF, Word, PowerPoint, audio, short video — up to 25 MB. For long videos or online games, use a link.',
    libraryAdminUrl: 'Link (https)',
    libraryAdminSave: 'Publish to library',
    libraryAdminEditSave: 'Save changes',
    libraryAdminSaving: 'Uploading…',
    libraryAdminSaved: 'Published to the library',
    libraryAdminTooBig: 'The file is over 25 MB — put it on YouTube or Drive and add it as a link.',
    libraryAdminMissing: 'Fill in grade, subject and title, and choose a file or enter a link.',
    libraryAdminExisting: 'Published for this grade',
    libraryAdminDelete: 'Delete',
    ...
    premadeSheetsPending: 'Ready-made worksheets are coming soon.',
    resourceKindWorksheet: 'Worksheet',
    resourceKindGame: 'Class activity',
    resourceKindText: 'Text',
    resourceActionPrint: 'Print',
    premadeSheetMeta: (n: number) => `${n} question${n === 1 ? '' : 's'} · answer key included`,
    resourceActionAddToClass: 'Add to class',
    resourceActionRun: 'Start activity',
    ...
    generateAILesson: 'Prepare a lesson plan',
    ...
    shelfReferenceOnly: (n: number) =>
      `${n} files written by teachers — for reference while you prepare, not for reprinting.`,
    shelfNotInApp: "The files themselves aren't in the app. Ask Iqraa to prepare material based on them.",
    ...
    poweredByAI: 'Powered by Iqraa',
    aiToolsSubtitle: 'From preparation to assessment — pick a tool for each stage of the lesson.',
    ...
    toolGeogebraTitle: 'GeoGebra',
    toolGeogebraDesc: 'Open the Graphing Calculator — maths only (equations, functions, geometry).',
    toolGeogebraBadge: 'Maths',
    ...
    toolSlidesDesc: 'Turn the lesson into slides for the screen: outcomes, vocabulary, explanation, worked examples.',
    slidesFromPromptLink: 'Or describe the slides in your own words →',
    toolPromptSlidesTitle: 'Create an interactive presentation',
    toolPromptSlidesDesc: 'Describe what you want in your own words and get full slides — free with an instant template, or AI-generated.',
    ...
    toolLessonMediaDesc: 'Attach an image or video to the current lesson so it appears in the class slides, and use quick templates.',
    parentMsgTitle: 'Message to parent',
    parentMsgSubtitle: 'Write a professional message in formal Arabic — you supply the facts, Iqraa handles the wording.',
    parentMsgStudentName: 'Student name',
    parentMsgStudentNamePlaceholder: 'e.g. Sara',
    parentMsgStudentGender: 'The student is a',
    parentMsgMale: 'Boy',
    ...
    parentMsgTeacherMale: 'Sign as معلّم (male)',
    parentMsgTeacherFemale: 'Sign as معلّمة (female)',
    ...
    parentMsgSentInApp: 'Sent to the parent',
    parentMsgPickForSend: 'Pick the student from your classes to send inside Iqraa.',
    parentMsgNoGuardian: 'No parent has linked an account for this student yet — use Share.',
    parentMsgRecipients: (names: string) => `Will reach: ${names}`,
    parentMsgConfirmTitle: 'Send the letter?',
    parentMsgConfirmSend: 'Send',
    parentMsgPartialSend: (sent: string, failed: string) => `Sent to ${sent}, but could not reach ${failed}. Tap "Send via Iqraa" again to retry.`,
    ...
    parentMsgHistoryLast: 'Last message:',
    parentMsgHistoryRecent: 'Last 30 days:',
    parentMsgHistoryRead: 'Read by the parent ✓',
    parentMsgHistoryUnread: 'Not read yet',
    parentMsgHistorySuggestMeeting: 'This is the third message on the same topic this month — inviting the parents to a meeting may work better.',
    ...
    toolQuizDesc: 'Check understanding with short questions, an answer key and a suggested time.',
    ...
    toolParentMsgTitle: 'Message to parent',
    ...
    aiLessonPlanBadge: 'Lesson plan',
    generateLessonPlanTitle: 'Lesson plan',
    ...
    generationFailed: 'Could not finish. Try again.',
    aiQuotaSpent:
    ...
    generateLessonPlanBtn: 'Prepare the lesson plan',
    ...
    generateQuizBtn: 'Prepare the quiz',
    ...
    iqraChatTitle: 'Iqraa',
    iqraChatSubtitle: 'Your prep companion',
    iqraWelcome: "Hi — I'm Iqraa, your lesson-prep companion.",
    iqraAgentName: 'Iqraa assistant',
    iqraAgentPitch: 'I help with planning, ideas, and building assessments. What do you need today?',
    groundedInCurriculum: (lesson: string) => `Based on the Jordanian curriculum — ${lesson}`,
    ...
    bookFiguresLessonNote: "This lesson's figures from your student book, with the printed page number.",
    iqraWelcomeDocs: "I'm Iqraa, your lesson-prep companion.\n\nUpload a lesson plan, PowerPoint, worksheet, or a photo of a textbook page — and I'll help you summarise, explain, build lesson plans, worksheets, homework, and quizzes from your own materials.",
    iqraPlaceholder: 'Write what you need…',
    iqraPlaceholderDocs: 'Ask about your files… or type: Summarize this lesson',
    iqraInputLabel: 'Your message to Iqraa',
    ...
    notFoundBody: 'The link may be out of date or mistyped. Go to one of these instead:',
    ...
    docStatusParsing: 'Reading the file…',
    docStatusOcr: 'Reading the image…',
    docStatusReady: 'Ready',
    docStatusError: 'Upload failed',
    ...
    docRejected: (name: string) => `Unsupported file type: ${name}. Use PDF, Word, PowerPoint, an image or text.`,
    ...
    iqraRules: 'Rules and formulas',
    iqraExamples: 'Examples',
    iqraTyping: 'Iqraa is thinking…',
    ...
    teaching: 'TEACHING',
    notSet: 'Not set',
    mySubjects: 'Subjects I teach',
    myGrades: 'Grades I teach',
    editProfile: 'Edit profile',
    changePhoto: 'Change photo',
    removePhoto: 'Remove photo',
    removePhotoConfirm: 'Remove your profile picture?',
    photoUpdateFailed: 'Could not update the photo. Try again.',
    ...
    deleteAccountWhatGoesTeacher: 'This also deletes: your classes, your student records and the notes you wrote about them, your exams and worksheets and their results, saved materials, files you uploaded, and messages you sent.',
    ...
    adaptationSimplifyChip: 'Simplify the explanation',
    adaptationSimplifyPreset: 'Use plain language and shorter steps, tie the idea to an example from everyday life, and avoid heavy jargon.',
    ...
    iqraPresentFailed: 'Could not prepare the slides. Try again.',
    exportBtn: 'Export',
    ...
    activityBadge: 'Class activity',
    createActivityTitle: 'Class activity',
    ...
    generateActivityBtn: 'Prepare the activity',
    ...
    lessonFlowBuildBtn: 'Build the lesson',
    ...
    lessonFlowLaunchClassroom: 'Show on the class screen',
    ...
    // Interactive Classroom Engine
    toolClassroomTitle: 'Interactive class',
    ...
    faqA5: 'Yes. Tap any item inside the plan to edit or delete it, and add new ones with "Add an item". Export takes the edited version, not the one first generated.',
    ...
    addMediaHint: 'Paste an image URL or a YouTube link — it becomes a slide on the class screen.',
    addMediaPlaceholder: 'https://…',
    ...
    activityBingoTitle: 'Maths bingo',
    ...
    // Dashboard extras
    continueWorking: 'Continue preparing',
    ...
    classroomBuilderTitle: 'Set up the activity',
    ...
    generateClassroomBtn: 'Prepare the activity',
    generatingClassroom: 'Building your activity…',
    classroomReady: 'Activity ready for presentation',
    startPresentation: 'Start presenting',
    slideCount: (n: number) => `${n} slide${n !== 1 ? 's' : ''}`,
    challengeCount: (n: number) => `${n} challenge${n !== 1 ? 's' : ''}`,
    // Slides Maker
    slidesTitle: 'Lesson slides',
    slidesSubtitle: 'Turn a lesson into projectable slides — outcomes, vocabulary, explanation, examples.',
    slidesBuild: 'Build the slides',
    ...
    promptRequired: 'Describe the slides you want first.',
    promptSlidesBuild: 'Build slides',
    promptSlidesBuilding: 'Building…',
    promptSlidesAsking: 'Reading your description…',
    promptSlidesBuildWithAnswers: 'Build slides',
    promptSlidesSkipQuestions: 'Skip the questions and build now',
    promptSlidesSlideCountLabel: 'Slide count (optional, up to 20)',
    promptSlidesFieldLabel: 'Deck description',
    promptSlidesSourceToggle: 'Paste a source text (optional)',
    promptSlidesSourceLabel: 'Source text',
    promptSlidesSourcePlaceholder: 'Paste the lesson text, an article, or your own notes — the slides will be built from it instead of from general knowledge.',
    promptSlidesSourceHint: 'Paste the text itself. Files (PDF, Word, PowerPoint) cannot be read on every device yet; pasted text always works.',
    promptSlidesSourceCount: (n: number, max: number) => `${n} of ${max} characters`,
    promptSlidesPillSlides: 'Up to 20 slides',
    promptSlidesPillImages: 'Generated images',
    promptSlidesPillExport: 'PDF & PPTX',
    promptSlidesEmptyTitle: 'Start your idea here',
    promptSlidesEmptyHint: 'Describe your slides above, then tap "Build slides".',
    // Class Challenge (phone-free team game)
    ...
    gameBuild: 'Build the challenge',
    gameBuilding: 'Building your challenge…',
    gameStart: 'Start the challenge',
    gameQuestionsReady: (n: number) => `${n} question${n !== 1 ? 's' : ''}`,
    gameTeamsReady: (n: number) => `${n} ${n === 1 ? 'team' : 'teams'}`,
    ...
    exitPresentation: 'End presentation',
    ...
    buildActivityFirst: 'Build an activity first',
    ...
    noClassesDesc: 'Create a class and add your students to track their level',
    ...
    addStudentsCodeHint: 'After adding, tap "Link code" on the class page and share it with parents and students — each person picks their own name from the class list when they sign up.',
    ...
    deleteClass: 'Archive class',
    archive: 'Archive',
    deleteClassConfirm: (name: string) =>
      `Archive "${name}"? It leaves your list; student records and attached materials are kept.`,
    ...
    rosterNeedsConnection: 'Your class list needs an internet connection',
    rosterStorageUnavailable: "Class storage isn't available yet. Contact Iqraa support.",
    rosterCreateFailed: 'Could not create the class. Try again.',
    rosterLoadFailed: 'Could not load your classes.',
    remove: 'Remove',

    // Teaching plans — a teacher's own notes on what they intend to teach
    myTeachingPlans: 'Teaching plans',
    newTeachingPlan: 'New teaching plan',
    editTeachingPlan: 'Edit teaching plan',
    saveTeachingPlan: 'Save',
    planTitle: 'Plan title',
    planTitlePlaceholder: 'e.g. Term 1 plan',
    schoolNamePlaceholder: 'School name',
    planClass: 'Class',
    planNoClass: 'No class',
    planScope: 'Grade and subject',
    planScopeFromClass: 'taken from the class',
    planNeedsClass: 'Every plan belongs to a class, and that is where its grade and subject come from. Create a class first.',
    planLegacyGrades: (v: string) => `Previously entered: ${v}`,
    planSchedule: 'Schedule',
    planScheduleHint: 'Set a start date and school days, then tap "Auto-schedule" to lay out the lessons — or set each lesson\'s date by hand below.',
    planNoLessons: 'No curriculum lessons for this class yet.',
    planPeriodsCount: (n: number) => `${n} period${n === 1 ? '' : 's'}`,
    planLessonsCount: (n: number) => `${n} lesson${n === 1 ? '' : 's'}`,
    planStartDate: 'Starting from',
    planMeetingDays: 'School days',
    planAutoSchedule: 'Auto-schedule',
    planAutoScheduleTitle: 'Replace the current schedule?',
    planAutoScheduleConfirm: 'Every lesson will be reassigned to the new dates, and any manual edits to the current schedule will be lost.',
    planAutoScheduleAction: 'Schedule',
    planWeekdaySun: 'Sun',
    planWeekdayMon: 'Mon',
    planWeekdayTue: 'Tue',
    planWeekdayWed: 'Wed',
    ...
    planWeekdayFri: 'Fri',
    planWeekdaySat: 'Sat',
    planTodayLesson: (title: string) => `Today: ${title}`,
    planNextLesson: (date: string, title: string) => `Next (${date}): ${title}`,
    planGrades: 'Grades',
    planGradesPlaceholder: 'e.g. Grade 9, Grade 10',
    planTopics: 'Topics',
    planTopicsPlaceholder: 'Topics you plan to teach',
    planDatePlaceholder: 'e.g. 2026-10-01',
    planTime: 'Time',
    planTimePlaceholder: 'e.g. Sun and Tue, 8–9 am',
    planNotesPlaceholder: 'Additional notes',
    noTeachingPlansYet: 'No teaching plans yet',
    noTeachingPlansDesc: 'Create a plan to keep track of the school, grades, topics and schedule',
    deleteTeachingPlan: 'Delete plan',
    deleteTeachingPlanConfirm: (title: string) =>
      `Delete "${title}"? The plan is archived and leaves your list.`,
    teachingPlansNeedsConnection: 'Teaching plans need a connection to the server',
    teachingPlansStorageUnavailable: "Teaching plan storage isn't available yet. Contact Iqraa support.",
    teachingPlansCreateFailed: 'Could not create the plan. Try again.',
    teachingPlansUpdateFailed: 'Could not update the plan. Try again.',
    ...
    scheduleSaveFailed: 'Could not save that change. Try again.',
    scheduleStorageUnavailable: "The weekly schedule isn't available yet. Contact Iqraa support.",
    scheduleNeedsConnection: 'The weekly schedule needs a server connection',
    scheduleViewTable: 'Timetable',
    scheduleViewDay: 'Day',
    scheduleViewCards: 'Cards',
    ...
    scheduleNewSchoolTitle: 'Add a school',
    scheduleNow: 'Now',
    scheduleFreePeriod: 'Free',
    scheduleTapToAssign: 'Tap to assign a class',
    ...
    masteryTitle: 'What needs reteaching',
    masteryBasis: (exams: string) => `Based on ${exams}`,
    masteryEmpty: 'No marked results yet',
    masteryEmptyDesc: 'Mark one exam and this will show what the class needs to go back over',
    masteryBelowGap: (below: string, total: string) => `${below} of ${total} below the pass mark`,
    ...
    miniEvalNoObjectives: 'No objectives for this class — choose a curriculum on the full exam screen',
    miniEvalGenerate: 'Write the questions',
    miniEvalGenerating: 'Generating questions…',
    miniEvalReviewHint: 'Check the three questions before your students see them',
    miniEvalPublish: 'Publish and share the link',
    ...
    evalRowQuestions: (n: number) => `${n} ${n === 1 ? 'question' : 'questions'}`,
    evalRowMarked: (n: number) => `${n} marked`,
    evalRowNoneMarked: 'none marked yet',
    selectBookLabel: 'Book',
    selectBookPlaceholder: 'Choose a book',
    bookNotEvaluable: "This book has no learning objectives entered yet, so questions can't be written for it",
    ...
    evalTitlePlaceholder: 'e.g. Unit 1 exam',
    generateAndCreateBtn: 'Create and generate questions',
    creatingEvaluation: 'Creating…',
    evaluationCreateFailed: 'Could not create the evaluation. Try again.',
    ...
    warningsLabel: 'Notes',
    unavailableTypesNote: (types: string) => `These types were skipped — they need questions written by hand: ${types}`,
    ...
    readAloudStart: 'Start recording',
    readAloudStop: (elapsed: string) => `Stop (${elapsed})`,
    readAloudUploading: 'Uploading…',
    readAloudHeard: 'What we heard:',
    readAloudTakesLeft: (n: string) => `${n} recording attempts left`,
    readAloudNoTakesLeft: 'You have used all your recording attempts for this question.',
    readAloudNoMic: 'Could not use the microphone. Allow access in your browser and try again.',
    readAloudFailed: 'Could not save that recording. Try again.',
    readAloudWebOnly: 'Recording works in a web browser. Open the exam link in a browser to record your answer.',
    shelfExternal: (n: string) => `Openly-licensed resources (${n})`,
    marksLabel: 'Marks',
    lessonMediaTitle: 'Watch',
    practiceTitle: 'Practise reading aloud',
    practiceIntro: 'Read the passage out loud, listen back, and try as many times as you like. Nothing is marked.',
    practiceScoring: 'Scoring…',
    practiceTryAgain: 'Try again',
    practiceFailed: 'Could not score that recording. Try again.',
    ...
    readAloudPassageLabel: 'Passage to read',
    readAloudPassageHint:
      'Paste real English — from the openly-licensed resources on the lesson shelf, or from the book. AI does not write these passages.',
    readAloudWordCount: (n: string, min: string, max: string) => `${n} words (needs ${min}–${max})`,
    readAloudObjectiveLabel: 'Objective it measures',
    readAloudObjectiveN: (n: string) => `Objective ${n}`,
    readAloudCompetencyLabel: 'Competency',
    addReadAloudBtn: 'Add a read-aloud question',
    dictationAddTitle: 'Add a dictation',
    dictationAddBtn: (n: string) => `Add ${n} ${n === '1' ? 'question' : 'questions'}`,
    dictationAddProgress: (done: string, total: string) => `Adding… ${done} of ${total}`,
    dictationAddFailed: 'Could not add the questions.',
    dictationAddPartial: (done: string, total: string) =>
      `Added ${done} of ${total}. The rest were not added — retry with just the remaining words.`,
    dictationReadAloudNote:
      'The teacher reads the words aloud. They appear in the question list to read from in front of the class.',
    dictationSourceRule: 'From the curriculum spelling rules',
    dictationSourceOwn: 'My own words',
    dictationRuleLabel: 'Rule',
    dictationRuleGrades: (grades: string) => `Grades ${grades}`,
    dictationCountLabel: 'How many questions',
    dictationOwnWordsLabel: 'Words or sentences',
    dictationOwnWordsHint:
      'One word or sentence per line, vowelled as the book prints it. The student writes what they hear.',
    dictationPreviewLabel: (n: string) => `What will be added (${n})`,
    dictationMarksEachLabel: 'Marks per question',
    addDictationBtn: 'Add a dictation',
    addOwnQuestionBtn: 'Add your own question',
    questionAddTitle: 'Your own question',
    questionEditTitle: 'Edit question',
    questionEditBtn: 'Edit question',
    questionDeleteBtn: 'Delete question',
    questionDeleteConfirm: 'Delete this question?',
    questionTypeLabel: 'Question type',
    questionStemLabel: 'Question',
    questionStatementLabel: 'Statement',
    questionOptionsLabel: 'Options — tap the circle to mark the correct answer',
    questionOptionN: (n: string) => `Option ${n}`,
    questionAnswerLabel: 'Correct answer',
    questionBlankTextHint: 'Type ____ (underscores) where each blank goes.',
    questionBlankN: (n: string) => `Blank ${n} answer — separate accepted spellings with /`,
    questionPairsLabel: 'Pairs — leave the left side empty to add a distractor',
    questionAddPair: 'Add a pair',
    questionScenarioLabel: 'Scenario or given data',
    questionModelAnswerLabel: 'Model answer',
    questionKeyConceptsLabel: 'Key ideas (one per line)',
    questionCriteriaLabel: 'Success criteria (one per line)',
    questionSaveBtn: 'Save',
    questionSaveFailed: 'Could not save the question.',
    regenerateKeepsOwnNote: 'Generated questions are replaced, including ones you edited. Questions you wrote yourself are kept.',
    dictationPlay: 'Listen',
    dictationPlaying: 'Playing…',
    dictationPlaysLeft: (n: string) => `${n} plays left`,
    dictationNoPlaysLeft: 'No plays left. Ask your teacher to say the word again.',
    dictationListenToTeacher: 'Your teacher reads the word aloud. Listen carefully, then answer.',
    dictationWebOnly: 'Open the exam in a browser to play the audio, or listen to your teacher.',
    dictationTapCorrect: 'Tap the correct spelling:',
    dictationWriteWhatYouHear: 'Write what you hear:',
    dictationWritePlaceholder: 'Write the word here',
    shelfEmbedOnly: 'View only — cannot be copied.',
    ...
    attemptStatusGrading: 'Marking',
    attemptStatusGraded: 'Marked',
    ...
    submitAndGradeBtn: 'Hand in and mark',
    submittingAttempt: 'Marking…',
    ...
    insufficientEvidence: 'Not enough answers to judge',
    ...
    takeUnansweredWarning: (n: string) => `You have not answered ${n} ${n === '1' ? 'question' : 'questions'}.`,
    ...
    scanFilledAll: (n: string) => `Filled ${n} ${n === '1' ? 'mark' : 'marks'} — check them, then save.`,
    ...
    gradedCountLabel: (n: number, total: number) => `${n} of ${total} students marked`,
    ...
    onboardingSkip: 'Skip',
    onboardingNext: 'Next',
    onboardingGetStarted: 'Start now',
    onboardingSlideLabel: (n: number, total: number) => `Slide ${n} of ${total}`,
    onboardingSlide1Title: 'The Jordanian curriculum, Arabic-first',
    onboardingSlide1Desc: 'Iqraa follows the official national curriculum, unit by unit: teachers prepare their lessons, parents and students follow their class.',
    onboardingSlide1Points: 'Grades 1 to 10\nTextbook units and lessons\nIn Arabic and English',
    onboardingSlide6Title: 'Ask Iqraa about any lesson',
    onboardingSlide6Desc: 'An assistant that knows the curriculum books: ask about a lesson or a way to explain it, and it takes you to the right tool in one tap.',
    onboardingSlide6Points: 'Answers from the curriculum books\nIdeas for explaining and warming up\nPoints you to the right tool',
    onboardingSlide2Title: 'The whole lesson, built in one go',
    onboardingSlide2Desc: 'Objectives, warm-up, activity, practice, worksheet and exit ticket — built in sequence, not as scattered pieces.',
    onboardingSlide2Points: 'Objectives and warm-up\nActivity and practice\nWorksheet and exit ticket',
    onboardingSlide4Title: 'Tools for every moment in class',
    onboardingSlide4Desc: 'Slides to project on the board, a phone-free team challenge, and figures from your textbook with their page numbers — ready before and during class.',
    onboardingSlide4Points: 'Slides to project\nA phone-free team challenge\nTextbook figures by page',
    onboardingSlide7Title: 'Worksheets and exit tickets in a minute',
    onboardingSlide7Desc: 'A worksheet with difficulty levels and an answer key, and an exit ticket that tells you what your students understood before they leave.',
    onboardingSlide7Points: 'Graded difficulty levels\nA ready answer key\nAn exit ticket to close the lesson',
    onboardingSlide8Title: 'Exams students answer on their phones',
    onboardingSlide8Desc: 'Generate a test from the lesson and share it with a link: students answer on their phones, marks are recorded, and you get every student\'s results.',
    onboardingSlide8Points: 'Questions from the curriculum\nShared with a link\nMarks and results recorded',
    onboardingSlide9Title: 'Your classes and timetable in one place',
    onboardingSlide9Desc: 'Add your classes and weekly timetable, and a teaching plan that tells you what to teach each class and when.',
    onboardingSlide9Points: 'Classes with a link code\nYour weekly timetable\nA teaching plan per class',
    onboardingSlide5Title: 'For parents and students too',
    onboardingSlide5Desc: "Enter the link code from the teacher to link your account to the class, get the teacher's messages and notifications, and browse the curriculum any time.",
    onboardingSlide5Points: 'A link code from the teacher\nTheir messages and notifications\nThe curriculum any time',
    onboardingBack: 'Back',
    ...
    messagingEmptyDescTeacher: 'Start a conversation with a parent or student linked to your class.',
    messagingNewMessage: 'New message',
    messagingCreateGroupError: 'Could not create the group. Try again.',
    messagingLoadError: 'Could not load conversations',
    messagingSendError: 'Could not send message',
    messagingImageSaveFailed: 'Could not save the image',
    ...
    messagingClaimCodeTitle: 'Link code for this student',
    messagingClaimCodeDesc: 'A code for this student only. The link code for the whole class is usually enough — use this one only to link a parent to this specific student.',
    messagingGenerateCode: 'New code',
    messagingCreateCode: 'Create code',
    messagingShareCode: 'Share code',
    messagingCodeShared: 'Code shared',
    messagingNoCodeYet: 'This student has no active code yet.',
    messagingRegenerateCode: 'New code',
    messagingRegenerateWarnTitle: 'Replace the current code?',
    messagingRegenerateWarnBody:
      'The current code stops working immediately. Anyone you already gave it to who has not signed up yet will need the new one.',
    messagingRegenerateConfirm: 'Replace',
    messagingStudentAccountsOffTitle: 'Student and parent accounts are not enabled',
    messagingStudentAccountsOffBody:
      'No one can create a student or parent account in this version, so a link code has nothing to redeem yet. Your class list and your notes are unaffected.',
    ...
    messagingNoContactsDesc:
      'The students in your classes do not have accounts yet. Open your class, tap "Link code", and share the code with parents and students so they can sign up.',
    messagingDisabledDesc: 'In-app messaging is not enabled in this version.',
    messagingClassChat: 'Class chat',
    joinCodeTitle: 'Link code',
    ...
    joinCodeGenerate: 'Create link code',
    joinCodeRegenerate: 'New code',
    ...
    joinAnotherClassDesc: 'Enter another link code to add a new link — another child, another parent for the same child, or another teacher.',
    joinAnotherClassSubmit: 'Join',
    joinAnotherClassSuccess: 'You have joined the class',
    joinAnotherClassDone: 'Done',
    ...
    claimRequiredSubmit: 'Link class',
    ...
    teacherSetupTitle: 'What do you teach?',
    teacherSetupDesc: "Pick the grades and subjects you teach so we can show you their curriculum. You can change this or add more later from your account.",
    teacherSetupGradesLabel: 'Grades',
    teacherSetupSubjectsLabel: 'Subjects',
    teacherSetupContinue: 'Show my curriculum',
    teacherSetupSave: 'Save',
    teacherSetupPickAtLeastOne: 'Pick at least one subject for each grade you added',
    teacherSetupFailed: 'Could not save your grades and subjects. Try again.',
    teacherSetupAddGrade: 'Add grade',
    teacherSetupNoGradesYet: 'Pick a grade below to start',
    teacherSetupRemoveGrade: (gradeName: string) => `Remove ${gradeName}`,
    editTeachingTitle: 'Grades and subjects',
    rosterLinked: 'Joined',
    ...
    messagingGroupNameLabel: 'Group name',
    messagingGroupNamePlaceholder: 'e.g. Grade 10A parents',
    ...
    messagingStudentCodes: 'Link code',
    messagingLeaveGroup: 'Leave group',
    messagingAllowStudentPosting: 'Allow students to post',
    messagingReadOnlyGroup: 'Only the teacher can post here',
    ...
    hubStreak: (n: number) => `🔥 ${n}-day streak`,
    hubWords: (n: number) => `${n} word${n === 1 ? '' : 's'}`,
    hubFlashcards: 'Flashcards',
    hubFlashcardsDesc: 'Hear the word, flip the card to see its meaning',
    hubListen: 'Listen and choose',
    hubListenDesc: 'Hear a word and pick the right one',
    hubMatch: 'Match the meaning',
    hubMatchDesc: 'Match each English word to its Arabic meaning',
    hubSpell: 'Spell it',
    hubSpellDesc: 'Hear the word and type it',
    hubScramble: 'Unscramble it',
    hubScrambleDesc: 'Hear the word and put its letters in order',
    hubPicture: 'Match the picture',
    hubPictureDesc: 'Match each picture to its English word',
    hubSpeaking: 'Say it',
    hubSpeakingDesc: 'Hear the word, record yourself saying it, then listen back',
    hubRecord: 'Record',
    hubStopRecording: 'Stop recording',
    hubRecording: 'Recording…',
    hubTapMicToRecord: 'Tap the microphone and say the word',
    hubHearYourself: 'Tap ▶ to hear yourself',
    hubMicDenied: 'This needs microphone access — ask a parent to enable it in Settings',
    hubDailyGoalDone: 'Well done — you practised today!',
    hubDailyGoalTodo: 'Practise today to keep your streak',
    hubRemindMe: 'Remind me to practise daily',
    hubBadgeFirstStar: 'First star',
    hubBadgePerfectRound: 'Perfect round',
    hubBadgeTenStars: '10 stars',
    hubBadgeThreeDayStreak: '3-day streak',
    hubBadgeFiveLessons: '5 lessons',
    hubBadgeWeekStreak: 'Week streak',
    hubBadgeFiftyStars: '50 stars',
    hubTapToFlip: 'Tap to flip',
    hubNext: 'Next',
    hubPrev: 'Back',
    hubHear: 'Listen',
    hubCheck: 'Check',
    hubCorrect: 'Well done ✔',
    hubWrong: (w: string) => `Correct answer: ${w}`,
    hubTypeHere: 'Type the word here',
    hubQuestion: (i: number, n: number) => `${i} of ${n}`,
    hubDone: 'Finished',
    hubScore: (c: number, n: number) => `You got ${c} of ${n}`,
    hubMoves: (n: number) => `Moves: ${n}`,
    hubAgain: 'Play again',
    ...
    playSubtractTitle: 'Subtraction Challenge',
    playSubtractDesc: 'How many subtractions can you solve before time runs out?',
    playDrillPickNumbersMax: 'Numbers up to',
    ...
    iqraDrillNumbersUpTo: (max: number) => `numbers up to ${max}`,
    iqraDrillReady: (title: string, detail: string, secs: number) =>
