...
const translations = {
  ar: {
    ...
    verificationCodePlaceholder: '٠٠٠٠٠٠',
    ...
    parentMsgPickForSend: 'اختر الطالب/ة من قائمة صفوفك لإرسال الرسالة داخل اقرأ.',
    ...
    masteryEmptyDesc: 'صحّح امتحانًا واحدًا ليظهر هنا ما يحتاج الصف مراجعته',
    ...
    miniEvalNoObjectives: 'لا أهداف متاحة لهذا الصف — اختر المنهاج من شاشة الامتحان الكامل',
    miniEvalGenerate: 'ولّد الأسئلة',
    miniEvalGenerating: 'جارٍ توليد الأسئلة…',
    miniEvalReviewHint: 'راجع الأسئلة الثلاثة قبل نشرها لطلابك',
    ...
    onboardingSlide5Desc: 'أدخل رمز الربط من المعلم لتربط حسابك بالصف، فتصلك رسائل المعلم وإشعاراته، وتتصفح المنهاج متى شئت.',
    ...
    messagingStudentAccountsOffBody:
      'لا يمكن إنشاء حساب طالب أو وليّ أمر في هذه النسخة، فلا يوجد ما يستفيد من رمز الربط الآن. قائمة صفّك وملاحظاتك تبقى كما هي.',
    ...
    joinPickYourNameFor: (className: string) => `اختر اسمك من قائمة صف «${className}»`,
    joinNameTaken: 'مرتبط بحساب',
    joinAnotherClass: 'الانضمام إلى صف آخر',
    ...
    joinAnotherClassSuccess: 'تم الانضمام إلى الصف بنجاح',
