...
const translations = {
  ar: {
    ...
    planSchedule: 'التوزيع الأسبوعي',
    planScheduleHint: 'اكتب رقم الأسبوع بجانب كل درس. اترك الخانة فارغة للدروس التي لن تُدرَّس ضمن هذه الخطة.',
    planWeekShort: 'أسبوع',
    ...
    planWeeksCount: (n: number) => arCountPhrase(n, 'أسبوع', 'أسبوعان', 'أسابيع'),
    planGrades: 'الصفوف',
  ...
  en: {
    ...
    planSchedule: 'Weekly plan',
    planScheduleHint: 'Put a week number next to each lesson. Leave it blank for lessons this plan will not cover.',
    planWeekShort: 'Week',
    ...
    planWeeksCount: (n: number) => `${n} week${n === 1 ? '' : 's'}`,
    planGrades: 'Grades',
