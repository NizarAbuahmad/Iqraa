...
const translations = {
  ar: {
    ...
    messagingNoContactsDesc:
      'لا يملك الطلاب في قائمتك حسابات بعد. افتح صفّك واضغط أيقونة المفتاح بجانب اسم الطالب لإنشاء رمز ربط، ثم شاركه مع وليّ الأمر أو الطالب ليُنشئ حسابه.',
  ...
  en: {
    ...
    messagingNoContactsDesc:
      'The students on your roster do not have accounts yet. Open your class, tap the key icon next to a student to create a link code, and share it with their parent or the student so they can sign up.',
