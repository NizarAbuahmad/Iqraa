...
const translations = {
  ar: {
    ...
    simplifyExplanationSubtitle: 'ورقة شرح للطالب: الفكرة بلغة بسيطة، مثال محلول، خطأ شائع، وأسئلة تحقّق',
    explainerBadge: 'ورقة للطالب',
    createExplainerTitle: 'بسّط الشرح لطلابك',
    generateExplainerBtn: 'جهّز ورقة الشرح',
    generatingExplainer: 'جارٍ التبسيط…',
    craftingExplainer: 'نصوغ الشرح بأبسط لغة ممكنة…',
    explainerStruggleLabel: 'ما الذي يتعثر فيه الطلاب؟ (اختياري)',
    explainerStrugglePlaceholder: 'مثال: لا يعرفون متى يستخدمون القانون',
    sectionBigIdea: 'الفكرة باختصار',
    sectionExplanation: 'الشرح خطوة بخطوة',
    sectionKeyWords: 'كلمات مفتاحية',
    sectionWorkedExample: 'مثال محلول',
    sectionMisconception: 'خطأ شائع',
    sectionSelfCheck: 'تحقّق من فهمك',
    sectionSelfCheckAnswers: 'الإجابات',
    workedExampleAnswerLabel: 'الإجابة:',
    explainerType: 'تبسيط الشرح',
    ...
    faqA3: 'خطة درس، ورقة عمل، واجب منزلي، اختبار قصير، نشاط صفي، وتبسيط الشرح — كلها من زر ➕. ما يمكن للمحادثة إنتاجه يظهر مباشرة في المحادثة، وما يحتاج شاشة خاصة (تبسيط الشرح، وضع الحصة، مسار الدرس، جيوجبرا) ينتقل إليها ومعه الدرس الحالي.',
  ...
  en: {
    ...
    simplifyExplanationSubtitle: 'A student handout — the idea in plain language, a worked example, the common mistake, and quick self-checks',
    explainerBadge: 'Student handout',
    createExplainerTitle: 'Simplify it for your students',
    generateExplainerBtn: 'Build the handout',
    generatingExplainer: 'Simplifying…',
    craftingExplainer: 'Putting it in the plainest language possible…',
    explainerStruggleLabel: 'What are students stuck on? (optional)',
    explainerStrugglePlaceholder: 'e.g. they do not know when to use the rule',
    sectionBigIdea: 'The Big Idea',
    sectionExplanation: 'Step by Step',
    sectionKeyWords: 'Key Words',
    sectionWorkedExample: 'Worked Example',
    sectionMisconception: 'A Common Mistake',
    sectionSelfCheck: 'Check Your Understanding',
    sectionSelfCheckAnswers: 'Answers',
    workedExampleAnswerLabel: 'Answer:',
    explainerType: 'Simplified explanation',
    ...
    faqA3: 'Lesson plan, worksheet, homework, quiz, class activity and simplify — all from the ➕. What the conversation can produce appears in the conversation; what needs its own screen (simplified explanation, class mode, lesson flow, GeoGebra) opens there carrying the current lesson with it.',
