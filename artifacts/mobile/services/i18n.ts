...
const translations = {
  ar: {
    ...
    iqraOutOfScope: 'لم أجد هذا الموضوع في قاعدة المعرفة الحالية.\n\nيمكنني مساعدتك في المواضيع التالية — اختر أيًّا منها:',
    iqraClarifySubject: 'سؤالك يتعلق بأكثر من مادة دراسية. أيّ مادة تقصد؟',
    iqraNoKbDisclaimer: '⚠️ ملاحظة: هذه الإجابة مستندة إلى المعرفة العامة وليست مأخوذة مباشرةً من الكتاب المدرسي الأردني.',
    iqraOfflineFallback: 'تعذّر الوصول إلى المساعد الآن. تحقق من اتصالك بالإنترنت وأعد المحاولة.',
    ...
    quickActionOpenLesson: '📖 فتح الدرس',
    iqraSource: 'المصدر',
    iqraUnit: 'الوحدة',
    ...
    selectUnit: 'اختر الوحدة الدراسية',
    ...
    classroomBadge: 'محرك الأنشطة',
    classroomHubTitle: 'الفصل التفاعلي',
    classroomHubSubtitle: 'محرك الأنشطة التعليمية',
    classroomHubDesc: 'أنشئ تجارب تعليمية تفاعلية وقدّمها مباشرةً في الفصل',
    activityComingSoon: 'قريبًا',
    activityEscapeTitle: 'تحدي الهروب',
    activityEscapeDesc: 'مجموعات تحل تحديات رياضية للهروب من المختبر بنظام الأكواد السرية',
    activityBingoTitle: 'الإنجو الرياضي',
    activityBingoDesc: 'استدعِ المصطلحات وشطّب المربعات – أول من يكمل صفًا يفوز',
    activityRelayTitle: 'سباق التتابع',
    activityRelayDesc: 'سلسلة من 4-6 مسائل متصلة – إجابة كل مسألة تفتح التالية',
    ...
    activityErrorDesc: 'ابحث عن الخطأ في الحل وصحّحه — تعلّم عميق من خلال اكتشاف الأخطاء',
    activityGalleryTitle: 'جولة المعارض',
    activityGalleryDesc: 'محطات تعليمية تتنقل بينها المجموعات وتناقش مسألة مختلفة في كل محطة',
    // Marketplace
    ...
    activityComplete: 'أحسنتم! النشاط اكتمل 🎉',
    celebrationMsg: 'عمل رائع!',
    // Workspace rename
    renameItem: 'تغيير الاسم',
    renamePrompt: 'اسم جديد',
    classroomBuilderTitle: 'ضبط النشاط',
    classroomBuilderSubtitle: 'تحدي الهروب',
    teachingGoalLabel: 'هدف التدريس',
  ...
  en: {
    ...
    toolClassroomDesc: 'Create interactive activities and present them live with full slide control and a built-in timer.',
    classroomBadge: 'Activity Engine',
    classroomHubTitle: 'Interactive Classroom',
    classroomHubSubtitle: 'Activity Engine',
    classroomHubDesc: 'Create engaging classroom experiences and present them live',
