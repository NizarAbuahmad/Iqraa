...
const translations = {
  ar: {
    ...
    deleteClassConfirm: (name: string) =>
      `حذف «${name}»؟ ستُؤرشَف الشعبة وتختفي من قائمتك، وتبقى سجلّات الطلبة والمواد المرتبطة بها محفوظة.`,
    ...
    messagingClaimCodeDesc: 'شارك هذا الرمز مع وليّ الأمر أو الطالب لربط حسابه بهذا الطالب في التطبيق',
    messagingGenerateCode: 'إنشاء رمز جديد',
    messagingCreateCode: 'إنشاء رمز الربط',
    messagingShareCode: 'مشاركة الرمز',
    messagingCodeShared: 'تمت مشاركة الرمز',
    messagingNoCodeYet: 'لا يوجد رمز فعّال لهذا الطالب بعد.',
    messagingRegenerateCode: 'إنشاء رمز جديد بدل الحالي',
    ...
    joinCodeGenerate: 'إنشاء رمز الربط',
    ...
    messagingStudentCodes: 'رموز ربط الطلبة',
  ...
  en: {
    ...
    messagingClaimCodeTitle: 'Link code',
    ...
    messagingCreateCode: 'Create link code',
