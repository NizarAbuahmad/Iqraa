...
const translations = {
  ar: {
    ...
    resourcesIntro:
      'أوراقٌ جاهزة للطباعة، وأنشطةٌ صفّية، ووسائطُ المنهج، ومصادرُ الكتب. اختر ما يناسب درسك.',
  ...
  en: {
    ...
    resourcesIntro:
      'Ready-to-print worksheets, classroom activities, curriculum media and the book resources. Pick what suits your lesson.',
