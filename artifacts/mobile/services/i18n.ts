...
const translations = {
  ar: {
    ...
    exportNotebook: 'فتح NotebookLM',
    exportNotebookSub: 'صدّر PDF أولاً، ثم ارفعه هناك لتوليد ملخّص صوتي',
  ...
  en: {
    ...
    exportNotebookSub: 'Export a PDF first, then upload it there for an audio overview',
