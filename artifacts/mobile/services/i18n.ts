...
const translations = {
  ar: {
    ...
    onboardingSlide4Desc: 'شرائح للعرض، تحدٍّ جماعي بلا هواتف، اختبارات وأوراق عمل — بمفاتيح إجابة يفحصها البرنامج رياضيًّا، وأشكال من كتابك برقم صفحتها.',
  ...
  en: {
    ...
    onboardingSlide2Desc: 'Objectives, warmup, activity, practice, worksheet, quick evaluation — one connected flow, not scattered pieces.',
