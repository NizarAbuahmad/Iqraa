...
const translations = {
  ar: {
    ...
    lessonProgressLabel: (done: number, total: number) => `${done} من ${total} جاهزة`,
    lessonNothingReady: 'لم نجهّز شيئاً بعد',
    lessonAllReady: 'الحصة جاهزة للتدريس 🎉',
    teacherMode: 'معلم',
    studentMode: 'طالب',

    // iQra chat — empty state, message actions, composer
    iqraHeroGreeting: 'كيف نحضّر حصة اليوم؟',
    iqraHeroSub: 'ارفع موادك أو ابدأ من اقتراح — ونبني معاً خطة الدرس وأوراق العمل والواجبات والاختبارات.',
    iqraStartUpload: 'ارفع مادة',
    iqraStartUploadSub: 'PDF · Word · عرض · صورة',
    iqraStartPlan: 'حضّر خطة درس',
    iqraStartPlanSub: 'أهداف ومسار وتوقيت',
    iqraStartWorksheet: 'أنشئ ورقة عمل',
    iqraStartWorksheetSub: 'تمارين متدرّجة للحصة',
    iqraStartExplain: 'بسّط مفهوماً',
    iqraStartExplainSub: 'شرح بلغة الطلاب',
    iqraStartPlanPrompt: 'حضّر خطة درس كاملة للدرس الحالي',
    iqraStartWorksheetPrompt: 'أنشئ ورقة عمل صفية للدرس الحالي',
    iqraStartExplainPrompt: 'بسّط لي شرح الدرس الحالي بلغة يفهمها الطلاب',
    iqraCopyMessage: 'نسخ',
    iqraExportMessage: 'تصدير',
    iqraScrollToLatest: 'أحدث رسالة',
    iqraComposerHint: 'Enter للإرسال · Shift+Enter لسطر جديد',
  ...
  en: {
    ...
    lessonProgressLabel: (done: number, total: number) => `${done} of ${total} ready`,
    lessonNothingReady: 'Nothing prepared yet',
    lessonAllReady: 'This lesson is ready to teach 🎉',

    // iQra chat — empty state, message actions, composer
    iqraHeroGreeting: 'What are we preparing today?',
    iqraHeroSub: 'Upload your materials or start from a suggestion — we’ll build the lesson plan, worksheets, homework and quizzes together.',
    iqraStartUpload: 'Upload material',
    iqraStartUploadSub: 'PDF · Word · slides · image',
    iqraStartPlan: 'Prepare a lesson plan',
    iqraStartPlanSub: 'Objectives, flow, timing',
    iqraStartWorksheet: 'Create a worksheet',
    iqraStartWorksheetSub: 'Scaffolded in-class practice',
    iqraStartExplain: 'Simplify a concept',
    iqraStartExplainSub: 'Explained in students’ words',
    iqraStartPlanPrompt: 'Prepare a full lesson plan for the current lesson',
    iqraStartWorksheetPrompt: 'Create an in-class worksheet for the current lesson',
    iqraStartExplainPrompt: 'Explain the current lesson in simple language students understand',
    iqraCopyMessage: 'Copy',
    iqraExportMessage: 'Export',
    iqraScrollToLatest: 'Jump to latest',
    iqraComposerHint: 'Enter to send · Shift+Enter for a new line',
