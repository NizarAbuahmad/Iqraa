...
const translations = {
  ar: {
    ...
    toolGameDesc: 'لعبة أسئلة بين فرق الصف — بلا هواتف: الطلاب يرفعون بطاقات الحروف وأنت تسجّل النقاط.',
    ...
    gameHow1: 'قسّم الصف إلى فرق، ووزّع بطاقات الحروف أ ب ج د.',
    gameHow2: 'يظهر السؤال على الشاشة ويبدأ المؤقت — الجميع يفكر بصمت.',
    gameHow3: 'عند انتهاء الوقت يرفع كل فريق بطاقته معًا، ثم تكشف الإجابة.',
  ...
  en: {
    ...
    toolGameDesc: 'A team quiz game with no phones — students raise letter cards and you score it on screen.',
    ...
    gameHow1: 'Split the class into teams and hand out the A B C D letter cards.',
    gameHow2: 'The question appears on screen and the timer starts — everyone thinks silently.',
    gameHow3: 'When time ends each team raises its card together, then you reveal the answer.',
