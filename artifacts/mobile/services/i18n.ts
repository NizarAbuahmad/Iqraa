...
const translations = {
  ar: {
    ...
    onboardingSlide1Title: 'المنهاج الأردني، بالعربية بالكامل',
    onboardingSlide1Desc: 'اقرأ يرافق الصفوف الثامن والتاسع والعاشر: المعلم يحضّر حصصه، والأهل والطلبة يتابعون صفهم.',
    ...
    onboardingSlide5Desc: 'أدخل رمز الصف من المعلم لتربط حسابك بالصف، فتصلك رسائل المعلم وإشعاراته، وتتصفح المنهاج متى شئت.',
    ...
    joinAnotherClassDesc: 'أدخل رمز صف آخر لربط حسابك به — لطفل آخر، أو ولي أمر آخر لنفس الطفل، أو معلم آخر.',
  ...
  en: {
    ...
    onboardingSlide1Title: 'The Jordanian curriculum, fully in Arabic',
    onboardingSlide1Desc: 'IQRA covers grades 8, 9 and 10: teachers prepare their lessons, parents and students follow their class.',
    ...
    onboardingSlide5Desc: "Enter the class code from the teacher to link your account to the class, get their messages and notifications, and browse the curriculum any time.",
    ...
    joinAnotherClassDesc: 'Enter another class code to link your account to it — another child, another parent for the same child, or another teacher.',
