...
import {
  G9_ENG_S1_BOOK_ID,
  buildG9EngSem1Catalog,
} from './curriculumG9EngSem1.ts';
import {
  G9_ENG_S2_BOOK_ID,
...
import {
  G9_GEO_S1_BOOK_ID,
  buildG9GeoSem1Catalog,
} from './curriculumG9GeoSem1.ts';
import {
  G9_GEO_S2_BOOK_ID,
...
import {
  G5_MATH_S2_BOOK_ID,
  buildG5MathSem2Catalog,
} from './curriculumG5MathSem2.ts';
import {
...
import {
  G5_ISLAMIC_S1_BOOK_ID,
  buildG5IslamicSem1Catalog,
} from './curriculumG5IslamicSem1.ts';
import {
  G5_ISLAMIC_S2_BOOK_ID,
...
import {
  G4_DIGITAL_S1_BOOK_ID,
  buildG4DigitalSem1Catalog,
} from './curriculumG4DigitalSem1.ts';
import {
  G4_ISLAMIC_S1_BOOK_ID,
  buildG4IslamicSem1Catalog,
} from './curriculumG4IslamicSem1.ts';
import {
  G4_ISLAMIC_S2_BOOK_ID,
...
import {
  G4_ENGLISH_S1_BOOK_ID,
  buildG4EnglishSem1Catalog,
} from './curriculumG4EnglishSem1.ts';
import {
  G4_ENGLISH_S2_BOOK_ID,
...
import {
  G3_MATH_S1_BOOK_ID,
  buildG3MathSem1Catalog,
} from './curriculumG3MathSem1.ts';
import {
  G3_MATH_S2_BOOK_ID,
...
import {
  G3_ISLAMIC_S1_BOOK_ID,
  buildG3IslamicSem1Catalog,
} from './curriculumG3IslamicSem1.ts';
import {
  G3_ISLAMIC_S2_BOOK_ID,
  buildG3IslamicSem2Catalog,
} from './curriculumG3IslamicSem2.ts';
import {
  G3_ARABIC_S1_BOOK_ID,
  buildG3ArabicSem1Catalog,
} from './curriculumG3ArabicSem1.ts';
import {
  G3_ARABIC_S2_BOOK_ID,
  buildG3ArabicSem2Catalog,
} from './curriculumG3ArabicSem2.ts';
import {
  G3_SOCIAL_S1_BOOK_ID,
  buildG3SocialSem1Catalog,
} from './curriculumG3SocialSem1.ts';
import {
  G3_SOCIAL_S2_BOOK_ID,
  buildG3SocialSem2Catalog,
} from './curriculumG3SocialSem2.ts';
import {
  G3_ENGLISH_S1_BOOK_ID,
  buildG3EnglishSem1Catalog,
} from './curriculumG3EnglishSem1.ts';
import {
  G3_ENGLISH_S2_BOOK_ID,
  buildG3EnglishSem2Catalog,
} from './curriculumG3EnglishSem2.ts';
import {
  G3_CREATIVE_ARTS_BOOK_ID,
  buildG3CreativeArtsCatalog,
} from './curriculumG3CreativeArts.ts';
import {
  G3_PE_S1_BOOK_ID,
...
import {
  G1_SCIENCE_S1_BOOK_ID,
  buildG1ScienceSem1Catalog,
} from './curriculumG1ScienceSem1.ts';
import {
  G1_SCIENCE_S2_BOOK_ID,
  buildG1ScienceSem2Catalog,
} from './curriculumG1ScienceSem2.ts';
import {
  G1_ISLAMIC_S1_BOOK_ID,
  buildG1IslamicSem1Catalog,
} from './curriculumG1IslamicSem1.ts';
import {
  G1_ISLAMIC_S2_BOOK_ID,
...
import {
  G1_ARABIC_S1_BOOK_ID,
  buildG1ArabicSem1Catalog,
} from './curriculumG1ArabicSem1.ts';
import {
  G1_ARABIC_S2_BOOK_ID,
  buildG1ArabicSem2Catalog,
} from './curriculumG1ArabicSem2.ts';
import {
  G1_SOCIAL_S1_BOOK_ID,
  buildG1SocialSem1Catalog,
} from './curriculumG1SocialSem1.ts';
import {
  G1_SOCIAL_S2_BOOK_ID,
  buildG1SocialSem2Catalog,
} from './curriculumG1SocialSem2.ts';
import {
...
import {
  G6_MATH_S2_BOOK_ID,
  buildG6MathSem2Catalog,
} from './curriculumG6MathSem2.ts';
import {
...
import {
  G6_SCIENCE_S2_BOOK_ID,
  buildG6ScienceSem2Catalog,
} from './curriculumG6ScienceSem2.ts';
import {
  G7_SCIENCE_S2_BOOK_ID,
  buildG7ScienceSem2Catalog,
} from './curriculumG7ScienceSem2.ts';
import {
  G7_DIGITAL_S1_BOOK_ID,
  buildG7DigitalSem1Catalog,
} from './curriculumG7DigitalSem1.ts';
import {
  G7_DIGITAL_S2_BOOK_ID,
  buildG7DigitalSem2Catalog,
} from './curriculumG7DigitalSem2.ts';
import {
  G7_SOCIAL_S1_BOOK_ID,
  buildG7SocialSem1Catalog,
} from './curriculumG7SocialSem1.ts';
import {
  G7_SOCIAL_S2_BOOK_ID,
  buildG7SocialSem2Catalog,
} from './curriculumG7SocialSem2.ts';
import {
  G7_FINLIT_S1_BOOK_ID,
  buildG7FinlitSem1Catalog,
} from './curriculumG7FinlitSem1.ts';
import {
  G7_FINLIT_S2_BOOK_ID,
  buildG7FinlitSem2Catalog,
} from './curriculumG7FinlitSem2.ts';
import {
  G7_VOC_S1_BOOK_ID,
  buildG7VocSem1Catalog,
} from './curriculumG7VocationalSem1.ts';
import {
  G7_VOC_S2_BOOK_ID,
  buildG7VocSem2Catalog,
} from './curriculumG7VocationalSem2.ts';
import {
  G7_CREATIVE_ARTS_BOOK_ID,
  buildG7CreativeArtsCatalog,
} from './curriculumG7CreativeArts.ts';
import {
  G7_PE_S1_BOOK_ID,
  buildG7PeSem1Catalog,
} from './curriculumG7PeSem1.ts';
import {
  G7_PE_S2_BOOK_ID,
...
import {
  G8_ARABIC_S2_BOOK_ID,
  buildG8ArabicSem2Catalog,
} from './curriculumG8ArabicSem2.ts';
import {
...
import {
  G8_SCIENCE_S1_BOOK_ID,
  buildG8ScienceSem1Catalog,
} from './curriculumG8ScienceSem1.ts';
import {
  G8_SCIENCE_S2_BOOK_ID,
  buildG8ScienceSem2Catalog,
} from './curriculumG8ScienceSem2.ts';
import {
  G9_CIV_S1_BOOK_ID,
...
import {
  G9_PE_S2_BOOK_ID,
  buildG9PeSem2Catalog,
} from './curriculumG9PeSem2.ts';
import {
  CHEM_S1_BOOK_ID,
...
export const KB_BOOKS: KBBook[] = [
  ...
  {
    id: G9_ENG_S1_BOOK_ID,
    gradeId: 'grade-9',
    subjectId: 'english',
    titleAr: 'اللغة الإنجليزية – الصف التاسع – الفصل الأول',
    titleEn: 'English – Grade 9 – Semester 1',
    semester: 1,
    source: 'iqra_curriculum_g9_eng_sem1.json (NCCD)',
  },
  {
    id: G9_ENG_S2_BOOK_ID,
    gradeId: 'grade-9',
    subjectId: 'english',
  ...
  {
    id: G9_GEO_S1_BOOK_ID,
    gradeId: 'grade-9',
    subjectId: 'geography',
    titleAr: 'الجغرافيا – الصف التاسع – الفصل الأول',
    titleEn: 'Geography – Grade 9 – Semester 1',
    semester: 1,
    source: 'iqra_curriculum_g9_geography_sem1.json (NCCD)',
  },
  {
    id: G9_GEO_S2_BOOK_ID,
    gradeId: 'grade-9',
    subjectId: 'geography',
  ...
  {
    id: G5_MATH_S2_BOOK_ID,
    gradeId: 'grade-5',
    subjectId: 'mathematics',
    titleAr: 'الرياضيات – الصف الخامس – الفصل الثاني',
    titleEn: 'Mathematics – Grade 5 – Semester 2',
    semester: 2,
    source: 'iqra_curriculum_g5_math_sem2.json (NCCD)',
  },
  {
  ...
  {
    id: G5_ISLAMIC_S1_BOOK_ID,
    gradeId: 'grade-5',
    subjectId: 'islamic',
    titleAr: 'التربية الإسلامية – الصف الخامس – الفصل الأول',
    titleEn: 'Islamic Education – Grade 5 – Semester 1',
    semester: 1,
    source: 'iqra_curriculum_g5_islamic_sem1.json (NCCD)',
  },
  {
    id: G5_ISLAMIC_S2_BOOK_ID,
    gradeId: 'grade-5',
    subjectId: 'islamic',
  ...
  },
  {
    ...
    titleEn: 'Mathematics – Grade 4 – Semester 1',
    semester: 1,
    source: 'iqra_curriculum_g4_math_sem1.json (NCCD)',
  },
  {
    id: G4_MATH_S2_BOOK_ID,
    gradeId: 'grade-4',
    subjectId: 'mathematics',
  ...
  {
    id: G4_DIGITAL_S1_BOOK_ID,
    gradeId: 'grade-4',
    subjectId: 'digital-literacy',
    titleAr: 'المهارات الرقمية – الصف الرابع – الفصل الأول',
    titleEn: 'Digital Skills – Grade 4 – Semester 1',
    semester: 1,
    source: 'iqra_curriculum_g4_digital_sem1.json (NCCD)',
  },
  {
    id: G4_ISLAMIC_S1_BOOK_ID,
    gradeId: 'grade-4',
    subjectId: 'islamic',
    titleAr: 'التربية الإسلامية – الصف الرابع – الفصل الأول',
    titleEn: 'Islamic Education – Grade 4 – Semester 1',
    semester: 1,
    source: 'iqra_curriculum_g4_islamic_sem1.json (NCCD)',
  },
  {
    id: G4_ISLAMIC_S2_BOOK_ID,
    gradeId: 'grade-4',
    subjectId: 'islamic',
  ...
  {
    id: G4_ENGLISH_S1_BOOK_ID,
    gradeId: 'grade-4',
    subjectId: 'english',
    titleAr: 'اللغة الإنجليزية – الصف الرابع – الفصل الأول',
    titleEn: 'English – Grade 4 – Semester 1',
    semester: 1,
    source: 'iqra_curriculum_g4_english_sem1.json (NCCD)',
  },
  {
    id: G4_ENGLISH_S2_BOOK_ID,
    gradeId: 'grade-4',
    subjectId: 'english',
  ...
  {
    id: G3_MATH_S1_BOOK_ID,
    gradeId: 'grade-3',
    subjectId: 'mathematics',
    titleAr: 'الرياضيات – الصف الثالث – الفصل الأول',
    titleEn: 'Mathematics – Grade 3 – Semester 1',
    semester: 1,
    source: 'iqra_curriculum_g3_math_sem1.json (NCCD)',
  },
  {
    id: G3_MATH_S2_BOOK_ID,
    gradeId: 'grade-3',
    subjectId: 'mathematics',
  ...
  {
    id: G3_ISLAMIC_S1_BOOK_ID,
    gradeId: 'grade-3',
    subjectId: 'islamic',
    titleAr: 'التربية الإسلامية – الصف الثالث – الفصل الأول',
    titleEn: 'Islamic Education – Grade 3 – Semester 1',
    semester: 1,
    source: 'iqra_curriculum_g3_islamic_sem1.json (NCCD)',
  },
  {
    id: G3_ISLAMIC_S2_BOOK_ID,
    gradeId: 'grade-3',
    subjectId: 'islamic',
    titleAr: 'التربية الإسلامية – الصف الثالث – الفصل الثاني',
    titleEn: 'Islamic Education – Grade 3 – Semester 2',
    semester: 2,
    source: 'iqra_curriculum_g3_islamic_sem2.json (NCCD)',
  },
  {
    id: G3_ARABIC_S1_BOOK_ID,
    gradeId: 'grade-3',
    subjectId: 'arabic',
    titleAr: 'اللغة العربية – الصف الثالث – الفصل الأول',
    titleEn: 'Arabic – Grade 3 – Semester 1',
    semester: 1,
    source: 'iqra_curriculum_g3_arabic_sem1.json (NCCD)',
  },
  {
    id: G3_ARABIC_S2_BOOK_ID,
    gradeId: 'grade-3',
    subjectId: 'arabic',
    titleAr: 'اللغة العربية – الصف الثالث – الفصل الثاني',
    titleEn: 'Arabic – Grade 3 – Semester 2',
    semester: 2,
    source: 'iqra_curriculum_g3_arabic_sem2.json (NCCD)',
  },
  {
    id: G3_SOCIAL_S1_BOOK_ID,
    gradeId: 'grade-3',
    subjectId: 'social',
    titleAr: 'الدراسات الاجتماعية – الصف الثالث – الفصل الأول',
    titleEn: 'Social Studies – Grade 3 – Semester 1',
    semester: 1,
    source: 'iqra_curriculum_g3_social_sem1.json (NCCD)',
  },
  {
    id: G3_SOCIAL_S2_BOOK_ID,
    gradeId: 'grade-3',
    subjectId: 'social',
    titleAr: 'الدراسات الاجتماعية – الصف الثالث – الفصل الثاني',
    titleEn: 'Social Studies – Grade 3 – Semester 2',
    semester: 2,
    source: 'iqra_curriculum_g3_social_sem2.json (NCCD)',
  },
  {
    id: G3_ENGLISH_S1_BOOK_ID,
    gradeId: 'grade-3',
    subjectId: 'english',
    titleAr: 'اللغة الإنجليزية – الصف الثالث – الفصل الأول',
    titleEn: 'English – Grade 3 – Semester 1',
    semester: 1,
    source: 'iqra_curriculum_g3_english_sem1.json (NCCD)',
  },
  {
    id: G3_ENGLISH_S2_BOOK_ID,
    gradeId: 'grade-3',
    subjectId: 'english',
    titleAr: 'اللغة الإنجليزية – الصف الثالث – الفصل الثاني',
    titleEn: 'English – Grade 3 – Semester 2',
    semester: 2,
    source: 'iqra_curriculum_g3_english_sem2.json (NCCD)',
  },
  {
    id: G3_CREATIVE_ARTS_BOOK_ID,
    gradeId: 'grade-3',
    subjectId: 'creative-arts',
    titleAr: 'التربية الفنّيّة والموسيقيّة والمسرحيّة – الصف الثالث',
    titleEn: 'Art, Music and Drama Education – Grade 3',
    // Not actually Semester 1 — this book has no semester split at all.
    // `semester` is required on KBBook, so 1 is used as the same technical
    // placeholder the id-namespacing scope uses (see g3CreativeArts.ts).
    semester: 1,
    source: 'iqra_curriculum_g3_creative_arts.json (NCCD)',
  },
  {
    id: G3_PE_S1_BOOK_ID,
    gradeId: 'grade-3',
  ...
  {
    id: G1_SCIENCE_S1_BOOK_ID,
    gradeId: 'grade-1',
    subjectId: 'science',
    titleAr: 'العلوم – الصف الأول – الفصل الأول',
    titleEn: 'Science – Grade 1 – Semester 1',
    semester: 1,
    source: 'iqra_curriculum_g1_science_sem1.json (NCCD)',
  },
  {
    id: G1_SCIENCE_S2_BOOK_ID,
    gradeId: 'grade-1',
    subjectId: 'science',
    titleAr: 'العلوم – الصف الأول – الفصل الثاني',
    titleEn: 'Science – Grade 1 – Semester 2',
    semester: 2,
    source: 'iqra_curriculum_g1_science_sem2.json (NCCD)',
  },
  {
    id: G1_ISLAMIC_S1_BOOK_ID,
    gradeId: 'grade-1',
    subjectId: 'islamic',
    titleAr: 'التربية الإسلامية – الصف الأول – الفصل الأول',
    titleEn: 'Islamic Education – Grade 1 – Semester 1',
    semester: 1,
    source: 'iqra_curriculum_g1_islamic_sem1.json (NCCD)',
  },
  {
    id: G1_ISLAMIC_S2_BOOK_ID,
    gradeId: 'grade-1',
    subjectId: 'islamic',
  ...
  {
    id: G1_ARABIC_S1_BOOK_ID,
    gradeId: 'grade-1',
    subjectId: 'arabic',
    titleAr: 'اللغة العربية – الصف الأول – الفصل الأول',
    titleEn: 'Arabic – Grade 1 – Semester 1',
    semester: 1,
    source: 'iqra_curriculum_g1_arabic_sem1.json (NCCD)',
  },
  {
    id: G1_ARABIC_S2_BOOK_ID,
    gradeId: 'grade-1',
    subjectId: 'arabic',
    titleAr: 'اللغة العربية – الصف الأول – الفصل الثاني',
    titleEn: 'Arabic – Grade 1 – Semester 2',
    semester: 2,
    source: 'iqra_curriculum_g1_arabic_sem2.json (NCCD)',
  },
  {
    id: G1_SOCIAL_S1_BOOK_ID,
    gradeId: 'grade-1',
    subjectId: 'social',
    titleAr: 'الدراسات الاجتماعية – الصف الأول – الفصل الأول',
    titleEn: 'Social Studies – Grade 1 – Semester 1',
    semester: 1,
    source: 'iqra_curriculum_g1_social_sem1.json (NCCD)',
  },
  {
    id: G1_SOCIAL_S2_BOOK_ID,
    gradeId: 'grade-1',
    subjectId: 'social',
    titleAr: 'الدراسات الاجتماعية – الصف الأول – الفصل الثاني',
    titleEn: 'Social Studies – Grade 1 – Semester 2',
    semester: 2,
    source: 'iqra_curriculum_g1_social_sem2.json (NCCD)',
  },
  {
    id: G1_CREATIVE_ARTS_BOOK_ID,
    gradeId: 'grade-1',
    subjectId: 'creative-arts',
    titleAr: 'التربية الفنّيّة والموسيقيّة والمسرحيّة – الصف الأول',
    titleEn: 'Art, Music and Drama Education – Grade 1',
    // Not actually Semester 1 — this book has no semester split at all.
    // `semester` is required on KBBook, so 1 is used as the same technical
  ...
  {
    id: G6_MATH_S2_BOOK_ID,
    gradeId: 'grade-6',
    subjectId: 'mathematics',
    titleAr: 'الرياضيات – الصف السادس – الفصل الثاني',
    titleEn: 'Mathematics – Grade 6 – Semester 2',
    semester: 2,
    source: 'iqra_curriculum_g6_math_sem2.json (NCCD)',
  },
  {
  ...
  },
  {
    ...
    titleEn: 'Science – Grade 6 – Semester 1',
    semester: 1,
    source: 'iqra_curriculum_g6_science_sem1.json (NCCD)',
  },
  {
    id: G6_SCIENCE_S2_BOOK_ID,
    gradeId: 'grade-6',
    subjectId: 'science',
    titleAr: 'العلوم – الصف السادس – الفصل الثاني',
    titleEn: 'Science – Grade 6 – Semester 2',
    semester: 2,
    source: 'iqra_curriculum_g6_science_sem2.json (NCCD)',
  },
  {
  ...
  {
    id: G7_DIGITAL_S1_BOOK_ID,
    gradeId: 'grade-7',
    subjectId: 'digital-literacy',
    titleAr: 'المهارات الرقمية – الصف السابع – الفصل الأول',
    titleEn: 'Digital Skills – Grade 7 – Semester 1',
    semester: 1,
    source: 'iqra_curriculum_g7_digital_sem1.json (NCCD)',
  },
  {
    id: G7_DIGITAL_S2_BOOK_ID,
    gradeId: 'grade-7',
    subjectId: 'digital-literacy',
    titleAr: 'المهارات الرقمية – الصف السابع – الفصل الثاني',
    titleEn: 'Digital Skills – Grade 7 – Semester 2',
    semester: 2,
    source: 'iqra_curriculum_g7_digital_sem2.json (NCCD)',
  },
  {
    id: G7_SOCIAL_S1_BOOK_ID,
    gradeId: 'grade-7',
    subjectId: 'social',
    titleAr: 'الدراسات الاجتماعية – الصف السابع – الفصل الأول',
    titleEn: 'Social Studies – Grade 7 – Semester 1',
    semester: 1,
    source: 'iqra_curriculum_g7_social_sem1.json (NCCD)',
  },
  {
    id: G7_SOCIAL_S2_BOOK_ID,
    gradeId: 'grade-7',
    subjectId: 'social',
    titleAr: 'الدراسات الاجتماعية – الصف السابع – الفصل الثاني',
    titleEn: 'Social Studies – Grade 7 – Semester 2',
    semester: 2,
    source: 'iqra_curriculum_g7_social_sem2.json (NCCD)',
  },
  {
    id: G7_FINLIT_S1_BOOK_ID,
    gradeId: 'grade-7',
    subjectId: 'financial-literacy',
    titleAr: 'الثقافة المالية – الصف السابع – الفصل الأول',
    titleEn: 'Financial Literacy – Grade 7 – Semester 1',
    semester: 1,
    source: 'iqra_curriculum_g7_financial_literacy_sem1.json (NCCD)',
  },
  {
    id: G7_FINLIT_S2_BOOK_ID,
    gradeId: 'grade-7',
    subjectId: 'financial-literacy',
    titleAr: 'الثقافة المالية – الصف السابع – الفصل الثاني',
    titleEn: 'Financial Literacy – Grade 7 – Semester 2',
    semester: 2,
    source: 'iqra_curriculum_g7_financial_literacy_sem2.json (NCCD)',
  },
  {
    id: G7_VOC_S1_BOOK_ID,
    gradeId: 'grade-7',
    subjectId: 'vocational-education',
    titleAr: 'التربية المهنية – الصف السابع – الفصل الأول',
    titleEn: 'Vocational Education – Grade 7 – Semester 1',
    semester: 1,
    source: 'iqra_curriculum_g7_vocational_sem1.json (NCCD)',
  },
  {
    id: G7_VOC_S2_BOOK_ID,
    gradeId: 'grade-7',
    subjectId: 'vocational-education',
    titleAr: 'التربية المهنية – الصف السابع – الفصل الثاني',
    titleEn: 'Vocational Education – Grade 7 – Semester 2',
    semester: 2,
    source: 'iqra_curriculum_g7_vocational_sem2.json (NCCD)',
  },
  {
    id: G7_CREATIVE_ARTS_BOOK_ID,
    gradeId: 'grade-7',
    subjectId: 'creative-arts',
    titleAr: 'التربية الفنّيّة والموسيقيّة والمسرحيّة – الصف السابع',
    titleEn: 'Art, Music and Drama Education – Grade 7',
    // Not actually Semester 1 — this book has no semester split at all.
    // `semester` is required on KBBook, so 1 is used as the same technical
    // placeholder the id-namespacing scope uses (see g7CreativeArts.ts).
    semester: 1,
    source: 'iqra_curriculum_g7_creative_arts.json (NCCD)',
  },
  {
    id: G7_PE_S1_BOOK_ID,
    gradeId: 'grade-7',
    ...
    titleEn: 'Physical Education – Grade 7 – Semester 1',
    semester: 1,
    source: 'iqra_curriculum_g7_physical_education_sem1.json (NCCD)',
  },
  {
    id: G7_PE_S2_BOOK_ID,
    gradeId: 'grade-7',
  ...
  {
    id: G8_ARABIC_S2_BOOK_ID,
    gradeId: 'grade-8',
    subjectId: 'arabic',
    titleAr: 'اللغة العربية – الصف الثامن – الفصل الثاني',
    titleEn: 'Arabic – Grade 8 – Semester 2',
    semester: 2,
    source: 'iqra_curriculum_g8_arabic_sem2.json (NCCD)',
  },
  {
  ...
  {
    id: G8_SCIENCE_S1_BOOK_ID,
    gradeId: 'grade-8',
    subjectId: 'science',
    titleAr: 'العلوم – الصف الثامن – الفصل الأول',
    titleEn: 'Science – Grade 8 – Semester 1',
    semester: 1,
    source: 'iqra_curriculum_g8_science_sem1.json (NCCD)',
  },
  {
    id: G8_SCIENCE_S2_BOOK_ID,
    gradeId: 'grade-8',
    subjectId: 'science',
    titleAr: 'العلوم – الصف الثامن – الفصل الثاني',
    titleEn: 'Science – Grade 8 – Semester 2',
    semester: 2,
    source: 'iqra_curriculum_g8_science_sem2.json (NCCD)',
  },
  {
    ...
    titleEn: 'National and Civic Education – Grade 9 – Semester 1',
    semester: 1,
    source: 'iqra_curriculum_g9_civic_education_sem1.json (NCCD)',
  },
  {
    id: G9_CIV_S2_BOOK_ID,
    gradeId: 'grade-9',
    subjectId: 'civic-education',
  ...
  },
  {
    ...
    titleEn: 'Physical Education – Grade 9 – Semester 1',
    semester: 1,
    source: 'iqra_curriculum_g9_physical_education_sem1.json (NCCD)',
  },
  {
    id: G9_PE_S2_BOOK_ID,
    gradeId: 'grade-9',
    ...
    titleEn: 'Physical Education – Grade 9 – Semester 2',
    semester: 2,
    source: 'iqra_curriculum_g9_physical_education_sem2.json (NCCD)',
  },
];
...
const _g3IslamicSem1 = buildG3IslamicSem1Catalog();
const _g3IslamicSem2 = buildG3IslamicSem2Catalog();
const _g3ArabicSem1 = buildG3ArabicSem1Catalog();
const _g3ArabicSem2 = buildG3ArabicSem2Catalog();
const _g3SocialSem1 = buildG3SocialSem1Catalog();
const _g3SocialSem2 = buildG3SocialSem2Catalog();
const _g3EnglishSem1 = buildG3EnglishSem1Catalog();
...
const _g1ArabicSem1 = buildG1ArabicSem1Catalog();
const _g1ArabicSem2 = buildG1ArabicSem2Catalog();
...
const _g5MathSem2 = buildG5MathSem2Catalog();
...
const _g4EnglishSem1 = buildG4EnglishSem1Catalog();
const _g4EnglishSem2 = buildG4EnglishSem2Catalog();
const _g6MathSem1 = buildG6MathSem1Catalog();
const _g6MathSem2 = buildG6MathSem2Catalog();
...
const _g7DigitalSem2 = buildG7DigitalSem2Catalog();
const _g7SocialSem1 = buildG7SocialSem1Catalog();
const _g7SocialSem2 = buildG7SocialSem2Catalog();
const _g7FinlitSem1 = buildG7FinlitSem1Catalog();
const _g7FinlitSem2 = buildG7FinlitSem2Catalog();
const _g7VocSem1 = buildG7VocSem1Catalog();
const _g7VocSem2 = buildG7VocSem2Catalog();
...
const _g8ScienceSem1 = buildG8ScienceSem1Catalog();
...
export const KB_UNITS: KBUnit[] = [
  ...
  ..._g3IslamicSem1.units,
  ..._g3IslamicSem2.units,
  ..._g3ArabicSem1.units,
  ..._g3ArabicSem2.units,
  ..._g3SocialSem1.units,
  ..._g3SocialSem2.units,
  ..._g3EnglishSem1.units,
  ...
  ..._g4ArabicSem1.units,
  ..._g4ArabicSem2.units,
  ..._g4EnglishSem1.units,
  ..._g4EnglishSem2.units,
...
export const KB_LESSONS: KBLesson[] = [
  ...
  ..._g3IslamicSem1.lessons,
  ..._g3IslamicSem2.lessons,
  ..._g3ArabicSem1.lessons,
  ..._g3ArabicSem2.lessons,
  ..._g3SocialSem1.lessons,
  ..._g3SocialSem2.lessons,
  ..._g3EnglishSem1.lessons,
  ...
  ..._g1ArabicSem1.lessons,
  ..._g1ArabicSem2.lessons,
  ...
  ..._g4EnglishSem1.lessons,
  ..._g4EnglishSem2.lessons,
  ...
  ..._g7DigitalSem2.lessons,
  ..._g7SocialSem1.lessons,
  ..._g7SocialSem2.lessons,
  ..._g7FinlitSem1.lessons,
  ..._g7FinlitSem2.lessons,
  ..._g7VocSem1.lessons,
  ..._g7VocSem2.lessons,
