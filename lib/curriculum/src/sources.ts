...
export interface CurriculumSource {
  ...
  subject: 'math' | 'chemistry' | 'financial-literacy' | 'physics' | 'biology' | 'earth-science' | 'arabic' | 'islamic' | 'history' | 'english' | 'geography' | 'digital-literacy' | 'civic' | 'art' | 'vocational' | 'physical-education' | 'science';
