...
export const getGenerateLessonPlanUrl = () => {
  ...
  return `/api/generate/lesson-plan`
}

/**
 * @summary Generate an AI lesson plan
 */
export const generateLessonPlan = async (generateRequest: GenerateRequest, options?: RequestInit): Promise<LessonPlanOutput> => {

  return customFetch<LessonPlanOutput>(getGenerateLessonPlanUrl(),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getGenerateLessonPlanMutationOptions = <TError = ErrorType<OpenaiError>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof generateLessonPlan>>, TError,{data: BodyType<GenerateRequest>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof generateLessonPlan>>, TError,{data: BodyType<GenerateRequest>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof generateLessonPlan>>, {data: BodyType<GenerateRequest>}> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type GenerateLessonPlanMutationBody = BodyType<GenerateRequest>
    export type GenerateLessonPlanMutationError = ErrorType<OpenaiError>

    /**
 * @summary Generate an AI lesson plan
 */
export const useGenerateLessonPlan = <TError = ErrorType<OpenaiError>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof generateLessonPlan>>, TError,{data: BodyType<GenerateRequest>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
...
export const getGenerateWorksheetUrl = () => {
  ...
  return `/api/generate/worksheet`
}

/**
 * @summary Generate an AI worksheet
 */
export const generateWorksheet = async (generateRequest: GenerateRequest, options?: RequestInit): Promise<WorksheetOutput> => {

  return customFetch<WorksheetOutput>(getGenerateWorksheetUrl(),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getGenerateWorksheetMutationOptions = <TError = ErrorType<OpenaiError>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof generateWorksheet>>, TError,{data: BodyType<GenerateRequest>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof generateWorksheet>>, TError,{data: BodyType<GenerateRequest>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof generateWorksheet>>, {data: BodyType<GenerateRequest>}> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type GenerateWorksheetMutationResult = NonNullable<Awaited<ReturnType<typeof generateWorksheet>>>
    export type GenerateWorksheetMutationBody = BodyType<GenerateRequest>
    export type GenerateWorksheetMutationError = ErrorType<OpenaiError>

    /**
 * @summary Generate an AI worksheet
 */
export const useGenerateWorksheet = <TError = ErrorType<OpenaiError>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof generateWorksheet>>, TError,{data: BodyType<GenerateRequest>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
 ...
 */
export const generateQuiz = async (generateRequest: GenerateRequest, options?: RequestInit): Promise<QuizOutput> => {
...
export const getGenerateQuizMutationOptions = <TError = ErrorType<OpenaiError>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof generateQuiz>>, TError,{data: BodyType<GenerateRequest>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof generateQuiz>>, TError,{data: BodyType<GenerateRequest>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof generateQuiz>>, {data: BodyType<GenerateRequest>}> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type GenerateQuizMutationBody = BodyType<GenerateRequest>
    export type GenerateQuizMutationError = ErrorType<OpenaiError>

    /**
 * @summary Generate an AI quiz
 */
export const useGenerateQuiz = <TError = ErrorType<OpenaiError>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof generateQuiz>>, TError,{data: BodyType<GenerateRequest>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
...
export const getChatWithIqraUrl = () => {
 ...
 */
export const chatWithIqra = async (iqraChatRequest: IqraChatRequest, options?: RequestInit): Promise<unknown> => {

  return customFetch<unknown>(getChatWithIqraUrl(),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(iqraChatRequest)
  }
);}
...
export const getChatWithIqraMutationOptions = <TError = ErrorType<OpenaiError>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof chatWithIqra>>, TError,{data: BodyType<IqraChatRequest>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof chatWithIqra>>, TError,{data: BodyType<IqraChatRequest>}, TContext> => {

const mutationKey = ['chatWithIqra'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof chatWithIqra>>, {data: BodyType<IqraChatRequest>}> = (props) => {
          const {data} = props ?? {};

          return  chatWithIqra(data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type ChatWithIqraMutationResult = NonNullable<Awaited<ReturnType<typeof chatWithIqra>>>
    export type ChatWithIqraMutationBody = BodyType<IqraChatRequest>
    export type ChatWithIqraMutationError = ErrorType<OpenaiError>

    /**
 * @summary Chat with iQra assistant (SSE stream)
 */
export const useChatWithIqra = <TError = ErrorType<OpenaiError>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof chatWithIqra>>, TError,{data: BodyType<IqraChatRequest>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof chatWithIqra>>,
        TError,
        {data: BodyType<IqraChatRequest>},
        TContext
      > => {
      return useMutation(getChatWithIqraMutationOptions(options));
    }
